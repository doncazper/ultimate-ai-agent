...
def test_authority_refs_cannot_authorize_redacted_preview(tmp_path, authority_ref):
...
def test_approval_ref_alone_cannot_authorize_redacted_preview(tmp_path):
...
def test_approval_test_ref_is_denied_for_redacted_preview(tmp_path):
...
def test_model_copy_mutated_raw_file_flag_is_denied(tmp_path):
...
def test_model_copy_mutated_tool_ref_to_raw_read_is_denied(tmp_path):
    decision = evaluate_tool_invocation(
