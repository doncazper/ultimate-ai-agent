...
def test_m19_mobile_companion_contract_criterion_exists_and_passes() -> None:
...
def test_m19_openapi_route_guard_rejects_mobile_runtime_expansion() -> None:
    ...
    assert EXPECTED_M19_OPENAPI_PATH_COUNT == 80
