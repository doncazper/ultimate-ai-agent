...
import scripts.verify_eco_005_private_crm as verifier


def test_eco_005_verifier_passes() -> None:
...
def test_eco_005_verifier_rejects_forbidden_runtime_imports_and_aliases(
    ...
    assert f"forbidden ECO-005 runtime ref: {runtime_ref}" in failures
