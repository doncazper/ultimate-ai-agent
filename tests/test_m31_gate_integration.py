...
def test_m31_foundation_gate_criteria_are_registered() -> None:
...
def test_m31_openapi_route_guard_rejects_tool_runtime_routes() -> None:
    ...
    assert EXPECTED_M31_OPENAPI_PATH_COUNT == 78
    assert m31_openapi_route_failures(app.openapi().get("paths", {})) == []


def test_m31_foundation_gate_evaluator_passes_current_contracts() -> None:
