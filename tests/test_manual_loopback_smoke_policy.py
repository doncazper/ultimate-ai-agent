...
def test_safe_smoke_policy_and_request_validate():
    policy = smoke_policy()
...
def test_smoke_request_rejects_remote_credentials_secret_query_and_unknown_fields():
    with pytest.raises(ValueError):
