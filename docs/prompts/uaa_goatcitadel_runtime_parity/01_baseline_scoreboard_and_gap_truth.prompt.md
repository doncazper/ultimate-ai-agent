...
This phase prevents vague "Goat parity" claims and defines the exact score
...
1. Inspect UAA's existing turn router, runtime gateway, model router,
   ...
   surfaces.
2. Inspect GoatCitadel read-only for the five reference areas named in the
   bundle README.
...
6. Mark GoatCitadel references as architectural evidence only. Do not infer
   UAA readiness from GoatCitadel code.
