# Execute UAA-GOATCITADEL-RUNTIME-PARITY-001 End To End
...
Goal: make UAA's real operation loop materially competitive with GoatCitadel's
...
- `VERSION.md`
- `SECURITY.md`
- `docs/prompts/uaa_goatcitadel_runtime_parity/README.md`
- every prompt in `docs/prompts/uaa_goatcitadel_runtime_parity/`
...
If the sibling GoatCitadel repo is available, inspect it read-only for reference
patterns only:
...
- Do not copy GoatCitadel code wholesale, import GoatCitadel packages, or adopt
  GoatCitadel authority assumptions.
...
- files changed;
- GoatCitadel patterns adapted as UAA-native designs;
