...
| First Local LLM Call M23 | `docs/runtime/FIRST_LOCAL_LLM_CALL_M23.md`, `docs/runtime/M23_LOCAL_MODEL_CALL_POLICY.md`, `docs/runtime/LOCAL_RUNTIME_M22_TO_M23_BOUNDARY.md` |
...
| Foundation Gate | `docs/implementation/foundation_gate_implementation_plan_v0_27_0.md`, `docs/evals/foundation_gate_eval.md` |
