...
The active accepted baseline is v0.79.0. v0.79.0 implements M75 Browser Action Dry-Run Planner as deterministic reviewable browser action dry-run planning over safe refs only, policy validation, request validation, step validation, receipt plans, documentation-integrity checks, static verification, and Foundation Gate coverage. It adds no browser action execution, browser session start, browser navigation execution, browser click execution, form fill execution, screenshot, raw DOM, authenticated browser profile, cookies or credentials, download or upload, remote browser, network interception, network call, model call, tool execution, memory write, context injection, backend route, Control Center control, dependency, M76 work, or production authority. v0.78.0 implements M74 Browser Observe-Only Adapter as a local observe-only adapter over explicit injected observation records, redacted visible text preview outputs, safe refs only, deterministic validation, documentation-integrity checks, static verification, and Foundation Gate coverage. It adds no browser automation, browser navigation, browser click, form fill, screenshot, raw DOM, authenticated browser profile, cookies or credentials, download or upload, remote browser, network interception, network call, model call, tool execution, memory write, context injection, backend route, Control Center control, dependency, M75 work, or production authority. M76-M100 remain planned/provisional.
