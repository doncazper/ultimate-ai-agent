...
The active accepted baseline is v0.26.1. It hardens M22 Local Model Runtime Activation Contract safety without starting M23. v0.26.0 remains the M22 contract/planning/validation release. v0.25.0 / M21 remains implemented/released as OpenWebUI Bridge + Chat Shell Integration Contract only, and v0.25.1 remains its safety hardening patch. v0.24.0 / M20 remains implemented/released as Device Capability Broker Contract only, and v0.24.1 remains its safety hardening patch. v0.23.0 / M19 is implemented/released as contract/API planning only. M23-M40 remain planned/provisional.
