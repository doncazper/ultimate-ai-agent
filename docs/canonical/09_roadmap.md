...
The active accepted baseline is v1.7.1. v1.7.1 repairs post-M103 roadmap versioning/currentness only. M103 remains the latest implemented capability baseline as Camera/Photos Metadata-Only Contract, with camera and photos off by default. Already-pushed v1.0.0 through v1.7.0 tags remain immutable historical internal milestone tags. Future M104-M149 conveyor snapshots use incremental v1.7.x internal tags, and M150 is the public product target v1.0.0-alpha. Beta begins only after the alpha UI and supporting safety/product work are reviewed, accepted, and explicitly promoted by a later roadmap patch. v1.7.1 adds no capability implementation, backend route, Control Center control, dependency, broad autonomy, mobile sensor runtime, M104 work, or production authority. M100 remains implemented/released as Mobile Permission Model v1. M101, M102, and M103 are implemented/released, and M104-M150 remain planned/provisional in `docs/roadmap/M101_M150_CAPABILITY_CHARTERS.md`.
