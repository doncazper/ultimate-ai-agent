# 09 - Roadmap v0.104.0 + Operator Runtime Excellence
...
product/package baseline is v0.104.0 / 0.104.0. M168 is accepted currentness
work under the Operator Runtime Excellence Program. M169 accepts the
v0.104.0 currentness, canonical-doc, GitHub, and branch-hygiene consolidation.
