# 09 - Roadmap v0.102.3 + Operator Runtime Excellence
...
accepted checkpoint tags are `checkpoint-m166` and `checkpoint-m167`; the
historical M150 alpha-target label remains v1.2.0-alpha as audit context, and
the active product/package baseline is v0.102.3 / 0.102.3. M168 is accepted
currentness work
under the Operator Runtime Excellence Program and adds no production authority,
backend route, Control Center control, dependency, public distribution, broad
autonomy, shell/subprocess authority, unrestricted network/browser automation,
connector writes, plugin runtime import, mobile control, model/provider output
