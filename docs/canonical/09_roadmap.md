...
The active accepted product baseline is v1.7.2. Checkpoint M110 is implemented/released as Mobile Sensor Hardening Freeze while the product baseline remains v1.7.2. M103 remains implemented/released as Camera/Photos Metadata-Only Contract, with camera and photos off by default. Checkpoint M104 remains implemented/released as Notification Planning, No Push Execution. Checkpoint M105 remains implemented/released as Background Task Contract, No Execution. Checkpoint M106 remains implemented/released as Mobile Background Read-Only Status Sync. Checkpoint M107 remains implemented/released as Mobile Approval Renewal UX. Checkpoint M108 remains implemented/released as Mobile Kill Switch + Revocation. Checkpoint M109 remains implemented/released as Mobile Sensor Audit Ledger. Already-pushed tags remain immutable historical internal milestone tags. Future M111-M149 conveyor milestones use checkpoint labels instead of product SemVer tags, and M150 is the next product release target v1.0.0-alpha. Beta begins only after the alpha UI and supporting safety/product work are reviewed, accepted, and explicitly promoted by a later roadmap patch. M110 adds no hardening runtime, sensor access, sensor read, raw sensor payload, location access, camera access, photos access, microphone access, background collection, native mobile UI, backend route, Control Center control, notification delivery, push trigger, background worker, scheduler, daemon, device token handling, external service, network sync, raw audit payload, dependency, memory write, context injection, execution, M111 work, broad autonomy, mobile sensor runtime, beta release, or production authority. M100 remains implemented/released as Mobile Permission Model v1. M101, M102, M103, M104, M105, M106, M107, M108, M109, and M110 are implemented/released, and M111-M150 remain planned/provisional in `docs/roadmap/M101_M150_CAPABILITY_CHARTERS.md`.
