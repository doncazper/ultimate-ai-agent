...
| Studio tab accepted design direction | `docs/design/STUDIO_TAB_PRODUCT_DIRECTION.md`, `docs/design/control_center_north_star/renders/target-v3/06-agent-studio-v3.png`, `docs/design/control_center_north_star/renders/target-v3/06-creative-studio-v1.png` |
