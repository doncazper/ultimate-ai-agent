...
v0.29.4 repairs documentation archive references and policy coverage only.
...
by this cleanup. M25 remains implemented/hardened. v0.29.2 remains the accepted
