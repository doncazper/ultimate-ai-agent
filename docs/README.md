...
| Social Media Intelligence founder-approved private-dogfood direction; owner foundations implemented and independent promotion deferred | `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/product/social_read_only_foundation_promotion_v1.json`, `scripts/verify_social_read_only_foundation_profile.py`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md`, `docs/backlog/codex_recommendation_log.md`, `docs/kanban/founder_command_center_board.md` |
