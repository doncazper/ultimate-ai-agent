...
| Runtime parity baseline | `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_SCORECARD.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `scripts/verify_uaa_goatcitadel_runtime_parity_scorecard.py` |
