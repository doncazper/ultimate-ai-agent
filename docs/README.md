...
Provenance Model work, and Ready Next UAA-P1-071 Memory Review Decision
Capture.
...
Product Spine Contract, and completed UAA-P1-069 Evidence History Grammar to
completed UAA-P1-070 Memory Source And Provenance Model, with UAA-P1-071
Memory Review Decision Capture now Ready Next. UAA-P1-066 remains queued as a
