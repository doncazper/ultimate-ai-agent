...
`docs/control_center/CREDENTIAL_VAULT_CONTRACT_SHELL.md`. The contracts live in
...
`scripts/inspect_credential_vault_contract.py`. They add no credential input,
