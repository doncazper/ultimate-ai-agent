...
| Runtime parity baseline | `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_SCORECARD.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ROUTE_DECISION_BINDING.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_STAGED_ORCHESTRATION_ENGINE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_PREPARED_TURN_LOOP.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ROLE_PROVIDER_EVIDENCE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ACTION_SIGNED_EVIDENCE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_FINAL_HARDENING.md`, `docs/runtime/UAA_HERMES_RUNTIME_DELEGATION_ADAPTER.md`, `docs/runtime/UAA_HERMES_RUNTIME_CAPABILITY_DISCOVERY.md`, `docs/runtime/UAA_HERMES_RUNTIME_RUN_EVENTS.md`, `docs/runtime/UAA_HERMES_RUNTIME_APPROVAL_BRIDGE.md`, `docs/runtime/UAA_HERMES_RUNTIME_STREAMING_PROGRESS.md`, `docs/runtime/UAA_HERMES_RUNTIME_PROFILE_ISOLATION.md`, `docs/runtime/UAA_HERMES_RUNTIME_MODEL_PROVIDER_CATALOG.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `scripts/verify_uaa_goatcitadel_runtime_parity_scorecard.py`, `scripts/verify_uaa_goatcitadel_runtime_route_decision_binding.py`, `scripts/verify_uaa_goatcitadel_runtime_turn_run_approval_chain.py`, `scripts/verify_uaa_goatcitadel_runtime_staged_orchestration.py`, `scripts/verify_uaa_goatcitadel_runtime_prepared_turn.py`, `scripts/verify_uaa_goatcitadel_runtime_role_provider_evidence.py`, `scripts/verify_uaa_goatcitadel_runtime_action_signed_evidence.py`, `scripts/verify_uaa_goatcitadel_runtime_parity_final.py`, `scripts/verify_hermes_runtime_adoption_phase_01.py`, `scripts/verify_hermes_runtime_adoption_phase_02.py`, `scripts/verify_hermes_runtime_adoption_phase_03.py`, `scripts/verify_hermes_runtime_adoption_phase_04.py`, `scripts/verify_hermes_runtime_adoption_phase_05.py`, `scripts/verify_hermes_runtime_adoption_phase_06.py`, `scripts/verify_hermes_runtime_adoption_phase_07.py` |
