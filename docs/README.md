...
authority.
FCC-MEM-015 extends that layer with backend-owned impact graph, follow-up queue,
and Recall Health V2 read models plus Control Center merge/supersede
comparison and context-pack preview inspection; it remains proposal-only and
does not add action execution, memory writes, CRM/account sync, context
injection, provider/model authority, semantic/vector search, or production
authority.
The 2026-06-24 memory hardening review and GoatCitadel comparison lives at
`docs/memory/MEMORY_MODULE_HARDENING_AND_GOATCITADEL_COMPARISON_2026_06_24.md`
and informed the FCC-MEM-016 through FCC-MEM-021 memory diagnostics, UI, and
proposal-bridge lanes.
...
| Memory Workbench / Impact Graph | `docs/control_center/FCC_MEM_001_MEMORY_WORKBENCH.md`, `docs/control_center/FCC_MEM_001_MEMORY_BASELINE_AUDIT.md`, `docs/control_center/FCC_MEM_015_MEMORY_IMPACT_GRAPH_AND_FOLLOW_UP_QUEUE.md`, `docs/control_center/FCC_MEM_016_020_MEMORY_DIAGNOSTICS_CITATIONS_FEEDBACK_MAINTENANCE_CONTEXT.md`, `docs/control_center/FCC_MEM_021_MEMORY_READ_MODELS_UI_ACTION_INBOX_BRIDGE.md`, `docs/memory/GOVERNED_COGNITIVE_MEMORY_SPINE_ROADMAP.md` |
...
`GET /control-center/local-models/status`, with Ollama and MLX-LM named only as
read-only readiness surfaces in the Optional Local Model Stack.
