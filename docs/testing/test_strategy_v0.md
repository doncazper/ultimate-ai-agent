...
Makefile targets `doctor`, `test`, `verify`, `verify-static`, `verify-gate-architecture`, `verify-fast`, `verify-dev-fast`, `verify-local`, `frontend-check`, `openapi`, and `ruff` use `.venv/bin/python`.
