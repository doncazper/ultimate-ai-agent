...
v0.30.0 implements deterministic local recall/context-pack contracts only. It
adds no recall execution route, context injection route, vector/embedding
runtime, model/provider call, memory write, dependency, or production authority.
