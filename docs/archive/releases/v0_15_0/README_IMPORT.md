...
v0.15.0 is a readiness/report-validation milestone. It adds runtime readiness contracts, capability matrix contracts, manual smoke report validation, status/validation API routes, and Foundation Gate checks. It does not add runtime execution, cloud/provider calls, remote execution, live mesh/tailnet integrations, mobile sensor access, plugin enablement, native builds, production persistence, or production readiness claims.
