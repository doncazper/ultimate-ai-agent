...
- Align README, VERSION, docs index, canonical map, roadmap, Kanban board,
  release notes, API route-count references, checkpoint labels, and Control
  Center currentness labels.
...
- Add repo-owned release-truth, public security, M167 evidence, local smoke,
  performance, and operator-shell mapping evidence.
