...
| UAA Social Media Intelligence product contract | `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md` (accepted planning-only direction for a creator-focused read-only Social surface, Social Media view in Communications, and dependency gate after Work Board/Kanban, first-class CRM, and Communications/Messenger; grants no connector runtime, publishing, reply, scheduling write, provider/model call, background sync, or production authority) |
