...
| UAA GoatCitadel catch-up prompt pack | `docs/control_center/UAA_GOATCITADEL_CATCHUP_SCOREBOARD.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_AGENT_LOOP_SPINE.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_DURABLE_ORCHESTRATION.md`, `docs/prompts/uaa_goatcitadel_catchup/00_execute_uaa_goatcitadel_catchup_end_to_end.prompt.md`, `docs/prompts/uaa_goatcitadel_catchup/README.md`, `docs/prompts/uaa_goatcitadel_catchup/prompt_bundle_manifest.json`, `scripts/dev/run_uaa_goatcitadel_catchup_prompt_pack.sh`, `scripts/verify_uaa_goatcitadel_catchup_prompt_pack.py`, `scripts/verify_uaa_goatcitadel_catchup_durable_orchestration.py` |
