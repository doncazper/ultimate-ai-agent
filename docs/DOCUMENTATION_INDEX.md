...
| Product vision preservation | `docs/roadmap/UAA_PRODUCT_VISION_REGISTRY.md`, `docs/roadmap/UAA_PRODUCT_VISION_REGISTRY.json`, `docs/implementation/UAA_AUTOCORRECT_CONTROLS_IMPLEMENTATION_PLAN.md`, `docs/implementation/UAA_GOVERNED_SELF_IMPROVEMENT_IMPLEMENTATION_PLAN.md`, `docs/implementation/UAA_SOCIAL_PUBLISHING_IMPLEMENTATION_PLAN.md`, `docs/evals/UAA_FINAL_GOATCITADEL_COMPARISON_PLAN.md`, `scripts/verify_product_vision_registry.py`, `tests/test_product_vision_registry.py` (binds first-class product and vertical Queue V2 slices to whole-vision outcomes and resolvable sources; planning/recovery grants no authority) |
