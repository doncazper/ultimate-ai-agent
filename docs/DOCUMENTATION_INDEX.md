...
| Governed self-improvement end-to-end prompt | `docs/prompts/governed_self_improvement_end_to_end.prompt.md`, `docs/control_center/FCC_HEALTH_001_SELF_HEALING_RECOMMENDATIONS_TO_INBOX.md`, `docs/control_center/UAA_P1_075_GOVERNED_CODE_WORKBENCH.md`, `docs/implementation/UAA_DEVELOPER_FEEDBACK_IMPLEMENTATION_PLAN.md`, `src/ultimate_ai_agent/core/control_center/health_recommendations.py`, `src/ultimate_ai_agent/core/task_decomposition/learning.py`, `src/ultimate_ai_agent/core/extension_catalog/contracts.py` |
