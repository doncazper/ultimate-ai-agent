...
| Tool-aware cognition and developer queue | `docs/strategy/UAA_TOOL_AWARE_COGNITION_AND_CHAT_QUALITY_PLAN.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW00_BASELINE.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW01_CAPABILITY_EVIDENCE.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW02_FAMILIARITY_ASSESSMENT.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW03_PROGRESSIVE_RETRIEVAL.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW04_CHAT_SHADOW.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW05_OUTCOMES.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW06_DIAGNOSTICS.md`, `docs/evals/tool_aware_cognition_q22_founder_dogfood_v1.json`, `docs/evals/tool_aware_cognition_taw00_protocol_v1.json`, `docs/roadmap/UAA_TOOL_AWARE_COGNITION_QUEUE_INSERTION.md`, `docs/roadmap/UAA_DEVELOPER_QUEUE_V2_MANIFEST.json`, `docs/roadmap/UAA_REMAINING_QUEUE_MANIFEST.json`, `docs/roadmap/UAA_DEVELOPER_QUEUE_RECOVERY_MANIFEST.json`, `docs/prompts/remaining_queue_recovery/`, `src/ultimate_ai_agent/core/capabilities/awareness.py`, `src/ultimate_ai_agent/core/capabilities/familiarity.py`, `src/ultimate_ai_agent/core/capabilities/retrieval.py`, `src/ultimate_ai_agent/core/capabilities/chat_shadow.py`, `src/ultimate_ai_agent/core/capabilities/outcomes.py`, `src/ultimate_ai_agent/core/capabilities/diagnostics.py`, `scripts/inspect_tool_aware_diagnostics.py`, `scripts/verify_tool_aware_cognition_plan.py`, `scripts/verify_tool_aware_cognition_taw00.py`, `scripts/verify_tool_aware_cognition_taw01.py`, `scripts/verify_tool_aware_cognition_taw02.py`, `scripts/verify_tool_aware_cognition_taw03.py`, `scripts/verify_tool_aware_cognition_taw04.py`, `scripts/verify_tool_aware_cognition_taw05.py`, `scripts/verify_tool_aware_cognition_taw06.py`, `tests/test_tool_aware_cognition_plan.py`, `tests/test_tool_aware_cognition_taw00.py`, `tests/test_tool_aware_cognition_taw01.py`, `tests/test_tool_aware_cognition_taw02.py`, `tests/test_tool_aware_cognition_taw03.py`, `tests/test_tool_aware_cognition_taw04.py`, `tests/test_tool_aware_cognition_taw05.py`, `tests/test_tool_aware_cognition_taw06.py` (Queue-of-Record V2 is authoritative; founder-private-dogfood Q22 implementation is accepted for English, Qwen 3.8 27B / 128K, configured ChatGPT/Codex OpenAI API profiles, and per-run observed Mac/Windows hardware; bounded TAW-01 capability evidence, TAW-02 familiarity assessment, TAW-03 progressive retrieval, TAW-04 evidence-only chat shadow, TAW-05 recomputable outcome evidence, and TAW-06 protected CLI/API diagnostics are present without runtime authority; the separate independent-promotion protocol remains fail-closed on external identity, measurement, and acceptance evidence) |
