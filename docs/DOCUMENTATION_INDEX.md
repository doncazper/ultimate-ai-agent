...
active M34-M60 sequence. v0.93.0 is the current active baseline after
implementing M89 Emergency Stop + Process Kill Safety as contract-only,
review-only, deterministic, local-only contracts over exact M88 Mutating
Command Proposal decisions. Active roadmap sources consistently
mark M34-M89 implemented/released, keep M90-M100 planned/provisional, and rely
...
Current release notes: `docs/release_notes/v0_93_0.md`
