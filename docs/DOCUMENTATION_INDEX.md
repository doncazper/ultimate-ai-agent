...
| ECO-003 reusable Boards and Task projections | `docs/architecture/ECO_003_REUSABLE_BOARDS_AND_TASK_PROJECTIONS.md`, `docs/decisions/ADR-0065-reusable-boards-and-task-projections.md`, `src/ultimate_ai_agent/core/ecosystem/boards.py`, `scripts/verify_eco_003_boards.py`, `tests/test_eco_003_boards.py` (encrypted versioned Boards, lanes, standalone cards, deterministic ordering, WIP, saved filters, templates, protected undo, and live ref-only canonical Task projections; no route/UI, Work Board cutover, mapped Task mutation, cloud collaboration, external runtime, or production authority) |
