...
| Governed self-improvement redacted intake | `docs/prompts/governed_self_improvement_intake.md` (subordinate summary only), `docs/roadmap/UAA_REMAINING_QUEUE_MANIFEST.json` (canonical queue truth; source not materialized and execution blocked) |
