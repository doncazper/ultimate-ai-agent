...
`scripts/verify_provider_invocation_promotion_plan.py`. It adds no credential
...
provider invocation runtime, no invocation authority from vault presence, and no
