...
and safe-disable/rollback posture. The contracts are backed by
...
`scripts/verify_background_autonomous_provider_plan.py`, plus
...
`tests/test_background_autonomous_provider_plan.py`. It adds no secret resolution
