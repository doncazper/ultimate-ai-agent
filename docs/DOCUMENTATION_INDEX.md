...
| UAA coherent app ecosystem implementation plan | `docs/implementation/UAA_COHERENT_APP_ECOSYSTEM_IMPLEMENTATION_PLAN.md` (full-vision, planning-only program for standalone-quality Calendar, Tasks, Boards, CRM, Inbox, Today, Organizer, and shared governed integration; grants no new runtime authority) |
