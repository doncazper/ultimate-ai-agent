...
Active Finance implementation: [FIN-003 synthetic in-app workflow](product/UAA_FINANCE_FIN003_SYNTHETIC_IN_APP_WORKFLOW.md)
documents the shared Core/CLI/API/Control Center slice and its remaining
recovery and qualification gates. This is not FIN-003 or Q26 completion.
...
| Product vision preservation | `docs/roadmap/UAA_PRODUCT_VISION_REGISTRY.md`, `docs/roadmap/UAA_PRODUCT_VISION_REGISTRY.json`, `docs/implementation/UAA_AUTOCORRECT_CONTROLS_IMPLEMENTATION_PLAN.md`, `docs/implementation/UAA_GOVERNED_SELF_IMPROVEMENT_IMPLEMENTATION_PLAN.md`, `docs/implementation/UAA_SOCIAL_PUBLISHING_IMPLEMENTATION_PLAN.md`, `docs/evals/UAA_FINAL_GOATCITADEL_COMPARISON_PLAN.md`, `docs/implementation/FOUNDER_FUNCTIONAL_ADOPTION_PROGRAM.md`, `scripts/verify_product_vision_registry.py`, `tests/test_product_vision_registry.py` (binds first-class product and vertical Queue V2 slices to whole-vision outcomes, direct chat UX comparison, and post-comparison functional adoption; planning/recovery grants no authority) |
| Q31 final GoatCitadel comparison candidate | `docs/benchmarks/Q31_FINAL_GOATCITADEL_COMPARISON_20260906.md`, `docs/benchmarks/q31_goat_maturity_input_20260906.json`, `docs/benchmarks/q31_goat_evidence_manifest_20260906.json`, `docs/benchmarks/q31_direct_observation_manifest_20260906.json`, `docs/benchmarks/q31_test_run_receipts_20260906.json`, `scripts/verify_queue_v2_q31_final_goatcitadel_comparison.py`, `tests/test_queue_v2_q31_final_goatcitadel_comparison.py` (completed at protected merge `b9b1f800087748c5b70c298d78ec1a34f9a8b0f1`; exact-revision skepticism-first maturity and direct-interaction evidence; GoatCitadel 73 and UAA 70 under the bound rubric; independent and controlled task validation remain unperformed; residual UAA owners are Q33 and Q36; no runtime, provider, model, repair, or production authority) |
| Q32 founder-private CRM functional adoption | `docs/control_center/Q32_CRM_FUNCTIONAL_ADOPTION.md`, `src/ultimate_ai_agent/core/crm/adoption.py`, `scripts/dev/uaa_crm.py`, `scripts/verify_queue_v2_q32_crm_functional_adoption.py`, `tests/test_crm_adoption.py`, `tests/test_queue_v2_q32_crm_functional_adoption.py`, `apps/control-center/src/components/CrmAdoptionWorkspace.tsx` (terminal at protected merge `63abb9931fe67546f979773af36f6b86efc471f9` with green post-merge CI and Supply Chain evidence; real operator-entry surface, encrypted local lifecycle, exact approval and Contacts/write lease, duplicate-aware import, encrypted backup/restore and recovery, safe-default CLI, and no external CRM write, provider/model call, fixture-primary truth, public claim, or production authority) |
| Q33 founder operating loop adoption | `docs/control_center/Q33_FOUNDER_OPERATING_LOOP_ADOPTION.md`, `src/ultimate_ai_agent/core/chat/workspace.py`, `src/ultimate_ai_agent/core/control_center/work_board_adoption.py`, `src/ultimate_ai_agent/core/control_center/calendar_adoption.py`, and their CLI/API/UI/verifier evidence (terminal at protected merge `d6d5b97ac87b51e002d236f32a035739a74a4f38` with green post-merge CI `34715302806` and Supply Chain `34715302797`; Chat, Setup, Decision-to-local-Task, Work Board, and Calendar are bounded founder-private product loops; no ordinary Chat model/send, task execution, external connector, automatic multi-device sync, or production authority) |
| Q34 News and source intelligence adoption | `docs/control_center/Q34_NEWS_SOURCE_INTELLIGENCE_ADOPTION.md`, `src/ultimate_ai_agent/core/news_signals/adoption.py`, `scripts/inspect_news_signals_adoption.py`, `scripts/verify_queue_v2_q34_news_source_intelligence.py`, `tests/test_q34_news_signals_adoption.py`, `tests/test_q34_news_signals_adoption_api.py`, `tests/test_q34_news_signals_adoption_cli.py`, `tests/test_queue_v2_q34_news_source_intelligence.py`, `apps/control-center/src/api/client.newsSignalsAdoption.test.ts`, `apps/control-center/src/components/NewsSignalsPreviewPanel.test.tsx` (bounded founder-private local operator intake, provenance/freshness/deduplication/ranking, preferences, archive/recovery, source safe-disable/recovery, undo, exact approval/lease/idempotency/receipt binding, and Today/Morning Briefing delivery; live source, account, browser, model/provider, connector write, external action, public, and production authority remain blocked) |
| First-class private macOS installer and updater | `docs/production/MACOS_FIRST_CLASS_INSTALLER.md`, `packaging/macos/README.md`, `packaging/macos/release-policy.json`, `src/ultimate_ai_agent/distribution/macos/`, `scripts/macos/`, `.github/workflows/macos-release.yml`, `tests/test_macos_first_class_installer.py` |
| Governed browser and external actions Queue 01 | Queue 01 items 01–13 `implemented_inactive`; immutable prior boundaries are Queue 01 items 01–03, Queue 01 items 01–04, Queue 01 items 01–05, Queue 01 items 01–06, Queue 01 items 01–07, Queue 01 items 01–08, Queue 01 items 01–09, Queue 01 items 01–10, Queue 01 items 01–11, and Queue 01 items 01–12: `docs/browser/GOVERNED_EXTERNAL_ACTIONS_QUEUE_01.md`, `src/ultimate_ai_agent/core/governed_browser/`, `tools/macos/governed-browser-keychain-helper/`, `scripts/dev/install_governed_browser_keychain_helper.py`, `scripts/verify_governed_browser_queue01_group01.py`, `scripts/verify_governed_browser_queue01_group02.py`, `scripts/verify_governed_browser_queue01_group03.py`, `scripts/verify_governed_browser_queue01_group04.py`, `scripts/verify_governed_browser_queue01_group05.py`, `scripts/verify_governed_browser_queue01_group06.py`, `scripts/verify_governed_browser_queue01_group07.py`, `scripts/verify_governed_browser_queue01_group08.py`, `scripts/verify_governed_browser_queue01_group09.py`, `scripts/verify_governed_browser_queue01_group10.py`, `scripts/verify_governed_browser_queue01_group11.py`, `tests/test_governed_browser_queue01_group01.py`, `tests/test_governed_browser_queue01_group02.py`, `tests/test_governed_browser_queue01_group03.py`, `tests/test_governed_browser_queue01_group04.py`, `tests/test_governed_browser_queue01_group05.py`, `tests/test_governed_browser_keychain_adapter.py`, `tests/test_governed_browser_queue01_group06.py`, `tests/test_governed_browser_queue01_group06_review_repairs.py`, `tests/test_governed_browser_queue01_group07.py`, `tests/test_governed_browser_queue01_group08.py`, `tests/test_governed_browser_queue01_group08_hardening.py`, `tests/test_governed_browser_queue01_group08_review_repairs.py`, `tests/test_governed_browser_queue01_group09.py`, `tests/test_governed_browser_queue01_group10.py`, `tests/test_governed_browser_queue01_group10_hardening.py`, `tests/test_governed_browser_queue01_group11.py` |
| Governed browser Queue 02 adversarial hardening | Shared-kernel race, timeout, exact-scope, receipt-integrity, hostile-state, recovery, and all-inactive activation evidence: `docs/browser/GOVERNED_EXTERNAL_ACTIONS_QUEUE_02_HARDENING.md`, `src/ultimate_ai_agent/core/governed_browser/adversarial_hardening.py`, `scripts/verify_governed_browser_queue02_hardening.py`, `tests/test_governed_browser_queue02_hardening.py` |
...
| Managed portable mission evidence signing | `docs/runtime/UAA_PORTABLE_MISSION_EVIDENCE_SIGNING.md`, `src/ultimate_ai_agent/core/evidence_signing/`, `tools/macos/portable-evidence-keychain-helper/`, `tests/test_portable_mission_evidence_signing.py`, `tests/test_portable_evidence_signing_lifecycle.py`, `tests/test_portable_evidence_signing_dispatcher.py`, `tests/test_macos_portable_evidence_keychain_backend.py` |
| UAA Runtime parity baseline | `docs/runtime/UAA_RUNTIME_PARITY_SCORECARD.md`, `docs/runtime/UAA_GOATCITADEL_PARITY_MATRIX.md`, `docs/runtime/UAA_RUNTIME_ROUTE_DECISION_BINDING.md`, `docs/runtime/UAA_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md`, `docs/runtime/UAA_RUNTIME_STAGED_ORCHESTRATION_ENGINE.md`, `docs/runtime/UAA_RUNTIME_PREPARED_TURN_LOOP.md`, `docs/runtime/UAA_RUNTIME_ROLE_PROVIDER_EVIDENCE.md`, `docs/runtime/UAA_RUNTIME_ACTION_SIGNED_EVIDENCE.md`, `docs/runtime/UAA_RUNTIME_PARITY_FINAL_HARDENING.md`, `docs/prompts/uaa_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `docs/prompts/uaa_runtime_parity/README.md`, `scripts/verify_uaa_runtime_parity_scorecard.py`, `scripts/verify_uaa_runtime_route_decision_binding.py`, `scripts/verify_uaa_runtime_turn_run_approval_chain.py`, `scripts/verify_uaa_runtime_staged_orchestration.py`, `scripts/verify_uaa_runtime_prepared_turn.py`, `scripts/verify_uaa_runtime_role_provider_evidence.py`, `scripts/verify_uaa_runtime_action_signed_evidence.py`, `scripts/verify_uaa_runtime_parity_final.py`, `tests/test_uaa_runtime_parity_scorecard.py`, `tests/test_route_decision_binding.py`, `tests/test_turn_run_approval_chain.py`, `tests/test_staged_orchestration_engine.py`, `tests/test_prepared_turn.py`, `tests/test_role_provider_evidence.py`, `tests/test_runtime_action_signed_evidence.py`, `tests/test_runtime_parity_loop_read_model.py` |
| Hermes/OpenClaw parity gap closure prompt pack | `docs/prompts/uaa_parity_gap_closure/README.md`, `docs/prompts/uaa_parity_gap_closure/00_execute_parity_gap_closure_end_to_end.prompt.md`, `docs/prompts/uaa_parity_gap_closure/prompt_bundle_manifest.json`, `scripts/dev/run_uaa_parity_gap_closure_prompt_pack.sh`, `scripts/verify_uaa_parity_gap_closure_prompt_pack.py`, `tests/test_uaa_parity_gap_closure_prompt_pack.py` |
| Governed self-improvement redacted intake | `docs/prompts/governed_self_improvement_intake.md` (subordinate summary only; canonical remaining-queue truth above remains source-not-materialized and execution-blocked) |
| Hermes/OpenClaw parity gap closure convergence ledger | `reports/parity_gap_closure/2026-07-22-convergence-ledger.md`, `scripts/verify_uaa_parity_gap_closure_phase01.py`, `tests/test_uaa_parity_gap_closure_phase01.py` |
| Queue V2 Q10 Hermes/OpenClaw current-source parity rebaseline | `reports/parity_gap_closure/2026-08-20-hermes-openclaw-parity-rebaseline.md`, `reports/parity_gap_closure/2026-08-20-hermes-openclaw-parity-rebaseline.json`, `scripts/verify_queue_v2_q10_parity_rebaseline.py`, `tests/test_queue_v2_q10_parity_rebaseline.py` (exact upstream revisions, finite close/defer/intentionally-exclude gap ledger, later-owner routing, and no authority grant) |
| Coding Pair Agent Relay Runner | `docs/control_center/CODING_PAIR_AGENT_RELAY_RUNNER.md`, `docs/prompts/coding_pair_agent_relay_runner/README.md`, `docs/prompts/coding_pair_agent_relay_runner/00_execute_coding_pair_agent_relay_runner_end_to_end.prompt.md`, `docs/prompts/authority_graduation_program/generated_unblock_prompts/unblock_coding_pair_agent_foreground_relay_runner.prompt.md`, `src/ultimate_ai_agent/core/code/pair_agent_relay.py`, `src/ultimate_ai_agent/core/code/coding_cockpit.py`, `scripts/dev/uaa_coding.py`, `scripts/verify_coding_pair_agent_relay_runner.py`, `tests/test_coding_pair_agent_relay_runner.py` |
...
| Tool-aware cognition and developer queue | `docs/strategy/UAA_TOOL_AWARE_COGNITION_AND_CHAT_QUALITY_PLAN.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW00_BASELINE.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW01_CAPABILITY_EVIDENCE.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW02_FAMILIARITY_ASSESSMENT.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW03_PROGRESSIVE_RETRIEVAL.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW04_CHAT_SHADOW.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW05_OUTCOMES.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW06_DIAGNOSTICS.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW07_HARDENING.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW08_ACCEPTANCE.md`, `docs/evals/tool_aware_cognition_q22_founder_dogfood_v1.json`, `docs/evals/tool_aware_cognition_taw00_protocol_v1.json`, `docs/evals/tool_aware_cognition_taw07_development_corpus_v1.json`, `docs/roadmap/UAA_TOOL_AWARE_COGNITION_QUEUE_INSERTION.md`, `docs/roadmap/UAA_DEVELOPER_QUEUE_V2_MANIFEST.json`, `docs/roadmap/UAA_REMAINING_QUEUE_MANIFEST.json`, `docs/roadmap/UAA_DEVELOPER_QUEUE_RECOVERY_MANIFEST.json`, `docs/prompts/remaining_queue_recovery/`, `src/ultimate_ai_agent/core/capabilities/awareness.py`, `src/ultimate_ai_agent/core/capabilities/familiarity.py`, `src/ultimate_ai_agent/core/capabilities/retrieval.py`, `src/ultimate_ai_agent/core/capabilities/chat_shadow.py`, `src/ultimate_ai_agent/core/capabilities/outcomes.py`, `src/ultimate_ai_agent/core/capabilities/diagnostics.py`, `src/ultimate_ai_agent/core/evals/tool_aware_hardening.py`, `src/ultimate_ai_agent/core/evals/tool_aware_acceptance.py`, `scripts/inspect_tool_aware_diagnostics.py`, `scripts/verify_tool_aware_cognition_plan.py`, `scripts/verify_tool_aware_cognition_taw00.py`, `scripts/verify_tool_aware_cognition_taw01.py`, `scripts/verify_tool_aware_cognition_taw02.py`, `scripts/verify_tool_aware_cognition_taw03.py`, `scripts/verify_tool_aware_cognition_taw04.py`, `scripts/verify_tool_aware_cognition_taw05.py`, `scripts/verify_tool_aware_cognition_taw06.py`, `scripts/verify_tool_aware_cognition_taw07.py`, `scripts/verify_tool_aware_cognition_taw08.py`, `tests/test_tool_aware_cognition_plan.py`, `tests/test_tool_aware_cognition_taw00.py`, `tests/test_tool_aware_cognition_taw01.py`, `tests/test_tool_aware_cognition_taw02.py`, `tests/test_tool_aware_cognition_taw03.py`, `tests/test_tool_aware_cognition_taw04.py`, `tests/test_tool_aware_cognition_taw05.py`, `tests/test_tool_aware_cognition_taw06.py`, `tests/test_tool_aware_cognition_taw07.py`, `tests/test_tool_aware_cognition_taw08.py` (Queue-of-Record V2 is authoritative; founder-private-dogfood Q22 implementation is accepted for English, Qwen 3.8 27B / 128K, configured ChatGPT/Codex OpenAI API profiles, and per-run observed Mac/Windows hardware; bounded TAW-01 capability evidence, TAW-02 familiarity assessment, TAW-03 progressive retrieval, TAW-04 evidence-only chat shadow, TAW-05 recomputable outcome evidence, TAW-06 protected CLI/API diagnostics, TAW-07 deterministic development hardening, and the TAW-08 acceptance contract are present without runtime authority; founder-private acceptance state may advance only through the content-addressed TAW-08 acceptance report and bounded active-truth reconciliations; the separate independent-promotion protocol remains gated) |
| TAW-08 evidence publication operations | `docs/evals/TOOL_AWARE_COGNITION_TAW08_EVIDENCE_PHASE_DRIVER.md`, `scripts/run_tool_aware_cognition_taw08_evidence_phases.py`, `scripts/taw08_evidence_phase_worker.py`, `tests/test_tool_aware_cognition_taw08_evidence_phases.py` (candidate-locked offline verification and owner-private publication tooling; model calls, independent promotion, and public claims remain outside this repository lane) |
...
| Connector draft-only proposals | `docs/control_center/CONNECTOR_DRAFT_ONLY_PROPOSALS.md`, `src/ultimate_ai_agent/core/connectors/connector_draft_proposals.py`, `scripts/inspect_connector_draft_proposals.py`, `tests/test_connector_draft_proposals.py` |
...
| Queue V2 Q21 Weekly Review private trial report | `docs/control_center/QUEUE_V2_Q21_WEEKLY_REVIEW_PRIVATE_TRIAL.md`, `docs/control_center/queue_v2_q21_private_trial_report_v1.json`, `scripts/verify_queue_v2_q21_weekly_review_private_trial.py`, `tests/test_queue_v2_q21_weekly_review_private_trial.py` (`report-ref:queue-v2:q21:weekly-review-private-trial:v1`; bounded local/private result with owned follow-ups and no authority promotion) |
...
| Dogfood Live Loop Acceptance | `docs/control_center/DOGFOOD_LIVE_LOOP_ACCEPTANCE.md`, `src/ultimate_ai_agent/core/control_center/dogfood_live_loop.py`, `scripts/dev/uaa_founder_loop.py`, `scripts/verify_dogfood_live_loop_acceptance.py`, `tests/test_dogfood_live_loop_acceptance.py` |
| FCC-THREAD-001 Unified Work Thread Read Model | `docs/control_center/FCC_THREAD_001_UNIFIED_WORK_THREAD.md`, `src/ultimate_ai_agent/core/control_center/unified_work_thread.py`, `scripts/dev/uaa_founder_loop.py`, `scripts/verify_fcc_thread_001_unified_work_thread.py`, `tests/test_fcc_thread_001_unified_work_thread.py` |
...
| Control Center UI wiring and capability surface coverage | `docs/control_center/UI_WIRING_REPORT.md`, `docs/design/control_center_north_star/UI_WIRING_MATRIX.md`, `docs/control_center/CAPABILITY_SURFACE_COVERAGE.md`, `docs/control_center/capability_surface_manifest.json`, `apps/control-center/src/routes.tsx`, `apps/control-center/src/api/client.ts`, `docs/control_center/release_surface_manifest.json`, `scripts/verify_control_center_capability_surface.py`, `tests/test_control_center_capability_surface_manifest.py` |
| Control Center UI/UX specification and north-star design files | `docs/design/CONTROL_CENTER_UI_UX_SPEC.md`, `docs/design/CONTROL_CENTER_PRODUCT_IA_AND_CALENDAR_CONTRACT.md`, `docs/design/STUDIO_TAB_PRODUCT_DIRECTION.md`, `docs/design/CONTROL_CENTER_RENDER_REVIEW_REVISION_02.md`, `docs/design/UAA_MESSENGER_MATRIX_IMPLEMENTATION_PLAN.md`, `docs/control_center/NEWS_AND_SIGNALS_MODULE_PLAN.md`, `docs/design/control_center_north_star/renders/news-signals-v1/README.md`, `docs/design/control_center_north_star/README.md`, `docs/design/control_center_north_star/APP_SHELL_BASELINE.md`, `docs/design/control_center_north_star/UAA_COMMUNICATIONS_MATRIX_NORTH_STAR.md`, `docs/design/control_center_north_star/SURFACE_COVERAGE.md`, `docs/design/control_center_north_star/UI_WIRING_MATRIX.md`, `docs/design/control_center_north_star/RENDER_MANIFEST.md`, `docs/design/control_center_north_star/RENDER_VARIATION_MATRIX.md`, `docs/design/control_center_north_star/render-review/README.md`, `docs/design/control_center_north_star/render-review/renders.json`, `scripts/dev/serve_control_center_render_review.py` |
| Messenger Matrix prompt bundle | `docs/prompts/messenger_matrix/README.md`, `docs/prompts/messenger_matrix/prompt_bundle_manifest.json`, `scripts/verify_messenger_matrix_prompt_pack.py`, `tests/test_messenger_matrix_prompt_pack.py` |
| Messenger Matrix MSG-MX-000 baseline authority map | `docs/connectors/MESSENGER_MATRIX_BASELINE_AUTHORITY_MAP.md`, `scripts/verify_msg_mx_000_baseline_authority_gate.py`, `tests/test_msg_mx_000_baseline_authority_gate.py` |
| Founder Command Center product narrative and strategy | `docs/strategy/FOUNDER_COMMAND_CENTER_MASTER_PLAN.md`, `docs/strategy/DELEGATED_LIFE_OS_NORTH_STAR.md`, `docs/strategy/MACOS_OF_AGENTS_PRODUCT_PRINCIPLES.md`, `docs/strategy/FOUNDER_COMMAND_CENTER_MVP_SPEC.md`, `docs/kanban/founder_command_center_board.md`, `docs/implementation/FOUNDER_COMMAND_CENTER_PHASE_0_1_TASKS.md`, `docs/control_center/FOUNDER_LOOP_V1_MILESTONES.md`, `docs/control_center/CONTROL_CENTER_RELEASE_SURFACE.md`, `docs/control_center/release_surface_manifest.json`, `docs/control_center/founder_loop_api_perimeter_manifest.json`, `docs/control_center/FCC_V1_002_ACTION_INBOX_STATE_MACHINE.md`, `docs/control_center/FCC_INBOX_001_APPROVAL_ENVELOPE_UX.md`, `docs/control_center/FCC_BRIEFING_001_MORNING_BRIEFING_TODAY_PLAN.md`, `docs/control_center/FCC_SOURCES_001_SOURCE_READINESS_DRAFT_ONLY_INPUTS.md`, `docs/control_center/FCC_MEMORY_CRM_001_PROFESSIONAL_MEMORY_CRM_LITE_BINDING.md`, `docs/control_center/FCC_REVIEW_001_EVIDENCE_NARRATIVE_WEEKLY_REVIEW.md`, `docs/control_center/FCC_HEALTH_001_SELF_HEALING_RECOMMENDATIONS_TO_INBOX.md`, `docs/macos/FCC_DOGFOOD_001_FOURTEEN_DAY_PRIVATE_HARNESS.md`, `docs/macos/private_operator_14_day_dogfood_harness_v1.json`, `docs/control_center/FCC_ACTION_001_APPROVAL_BOUND_LOCAL_AUTHORITY_CAPABILITY.md`, `docs/control_center/FCC_POLISH_001_NATIVE_APPLE_GRADE_UX_LAYER.md`, `docs/control_center/visual_regression_manifest.json`, `docs/control_center/FCC_V1_003_FOUNDER_LOOP_VERTICAL_SLICE.md`, `docs/control_center/FCC_V1_004_CHAT_DURABLE_RECEIPT_HANDOFF.md`, `docs/control_center/FCC_V1_005_MEMORY_REVIEW_DECISIONS.md`, `docs/control_center/FCC_V1_006_EVIDENCE_TIMELINE_PRODUCTIZATION.md`, `docs/control_center/FCC_V1_007_PROMOTION_AND_PROOF_LANE.md`, `docs/control_center/FOUNDER_LOOP_V1_PRODUCT_PROOF_PASS.md`, `docs/control_center/DOGFOOD_LIVE_LOOP_ACCEPTANCE.md`, `docs/control_center/FCC_LOOP_002_FOUNDER_LOOP_ERGONOMICS_PASS.md`, `docs/control_center/PRODUCT_LOOP_004_FOLLOW_UP_TRACKER.md`, `docs/control_center/PRODUCT_LOOP_005_ACTION_INBOX_DECISION_LANES.md`, `docs/control_center/PRODUCT_LOOP_009_CHAT_TO_LOOP_HANDOFF.md`, `docs/control_center/PRODUCT_LOOP_010_EVIDENCE_TIMELINE_NARRATIVE.md`, `docs/control_center/PRODUCT_LOOP_011_SETTINGS_KILL_SWITCH_CLARITY.md`, `docs/control_center/UAA_P1_065_FOUNDER_COMMAND_CENTER_REVIEW_CLEANUP.md`, `docs/control_center/UAA_P1_068_TODAY_PRODUCT_SPINE_CONTRACT.md`, `docs/control_center/UAA_P1_069_EVIDENCE_HISTORY_GRAMMAR.md`, `docs/control_center/UAA_P1_070_MEMORY_SOURCE_PROVENANCE_MODEL.md`, `docs/control_center/UAA_P1_071_MEMORY_REVIEW_DECISION_CAPTURE.md`, `docs/control_center/UAA_P1_072_BUSINESS_MEMORY_QUALITY_CONTROLS.md`, `docs/control_center/UAA_P1_073_PLANS_ACTION_ENVELOPES.md`, `docs/control_center/UAA_P1_074_CHAT_LOCAL_OPERATOR_SURFACE.md`, `docs/control_center/UAA_P1_075_GOVERNED_CODE_WORKBENCH.md`, `docs/control_center/UAA_P1_076_CROSS_SURFACE_MEMORY_INTAKE.md`, `docs/control_center/UAA_P1_077_MEMORY_TO_LOOP_BINDING.md`, `docs/macos/UAA_P1_087_PRIVATE_OPERATOR_BOOT_AND_UI_TRIAL_SEQUENCE.md`, `docs/macos/UAA_P1_087_2A_PRIVATE_TRIAL_PACKET_AND_UI_TUNING_SURFACE.md`, `docs/macos/UAA_P1_087_2B_PRIVATE_TRIAL_ACCEPTANCE_LEDGER.md`, `docs/macos/UAA_P1_087_2C_PRIVATE_TRIAL_MANUAL_REVIEW_SCAFFOLD.md` |
| FCC-LOOP-003 Review-Stage Readability implementation plan | `docs/implementation/FCC_LOOP_003_REVIEW_STAGE_READABILITY_IMPLEMENTATION_PLAN.md` (proposed frontend-first refinement; no API, execution, plugin, connector, model/provider, browser/shell, memory, context, or production authority) |
| Next capability and product prompt pack | `docs/prompts/uaa_next_capability_product_prompts.md` |
| Skill Workbench discovery and adoption prompt pack | `docs/prompts/skill_workbench_adoption_prompt_pack.md` |
| Kanban Board / Work Board prompt pack | `docs/prompts/kanban_board/00_execute_kanban_board_end_to_end.prompt.md`, `docs/prompts/kanban_board/README.md`, `docs/prompts/kanban_board/prompt_bundle_manifest.json` |
| Social Media Intelligence private-dogfood direction and deferred implementation prompt | `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md`, `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/backlog/codex_recommendation_log.md`, `docs/kanban/founder_command_center_board.md` |
| UAA runtime capability foundation prompt pack | `docs/benchmarks/runtime_capability_foundation/phase00_baseline.json`, `docs/benchmarks/runtime_capability_foundation/phase09_scenario_results.json`, `docs/benchmarks/runtime_capability_foundation/phase09_final_scorecard.json`, `docs/control_center/UAA_RUNTIME_CAPABILITY_SCOREBOARD.md`, `docs/control_center/UAA_RUNTIME_CAPABILITY_FINAL_SCORECARD.md`, `docs/control_center/UAA_RUNTIME_AGENT_LOOP_SPINE.md`, `docs/control_center/UAA_RUNTIME_DURABLE_ORCHESTRATION.md`, `docs/control_center/UAA_RUNTIME_ACTION_TOOL_CODE_LANES.md`, `docs/control_center/UAA_RUNTIME_MEMORY_LEARNING.md`, `docs/control_center/UAA_RUNTIME_EVIDENCE_AUDIT.md`, `docs/control_center/UAA_RUNTIME_COCKPIT_CLI_API.md`, `docs/control_center/UAA_RUNTIME_EXTENSIBILITY_FINAL.md`, `docs/prompts/uaa_runtime_capability_foundation/00_execute_uaa_runtime_capability_foundation_end_to_end.prompt.md`, `docs/prompts/uaa_runtime_capability_foundation/README.md`, `docs/prompts/uaa_runtime_capability_foundation/prompt_bundle_manifest.json`, `docs/prompts/uaa_runtime_capability_foundation/prompt_module_manifest.json`, `docs/prompts/uaa_runtime_capability_foundation/prompt_module_golden_receipt.json`, `scripts/dev/run_uaa_runtime_capability_foundation_prompt_pack.sh`, `scripts/dev/uaa_extensions.py`, `scripts/run_uaa_runtime_phase09_benchmark.py`, `scripts/verify_uaa_runtime_phase09_benchmark.py`, `scripts/verify_uaa_runtime_capability_final_scorecard.py`, `scripts/verify_uaa_runtime_capability_foundation_prompt_pack.py`, `scripts/verify_uaa_runtime_capability_scoreboard.py`, `scripts/verify_uaa_runtime_durable_orchestration.py`, `scripts/verify_uaa_runtime_action_tool_code_lanes.py`, `scripts/verify_uaa_runtime_memory_learning.py`, `scripts/verify_uaa_runtime_evidence_audit.py`, `scripts/verify_uaa_runtime_cockpit_cli_api.py`, `scripts/verify_uaa_runtime_extensibility_final.py` |
| Prompt module dependency compiler | `docs/runtime/UAA_PROMPT_MODULE_COMPILER.md`, `docs/schemas/prompt_module_manifest.schema.json`, `src/ultimate_ai_agent/core/prompt_compiler/`, `scripts/dev/uaa_prompt_compiler.py`, `tests/test_prompt_module_compiler.py` |
| UAA 16-component evidence-gated maturity plan | `docs/benchmarks/runtime_capability_foundation/CAPABILITY_MATURITY_UPLIFT_20260713.md`, `src/ultimate_ai_agent/core/evals/capability_maturity.py`, `scripts/run_agent_capability_evaluation.py`, `scripts/verify_capability_maturity_uplift.py`, `tests/test_agent_capability_evaluation.py` |
| UAA runtime capability foundation Phase 07 model/provider/research posture | `docs/control_center/UAA_RUNTIME_MODEL_PROVIDER_RESEARCH.md`, `src/ultimate_ai_agent/core/providers/control_plane.py`, `scripts/verify_uaa_runtime_model_provider_research.py`, `tests/test_runtime_model_provider_research.py` |
...
| Hermes runtime model slot posture | `docs/runtime/UAA_HERMES_RUNTIME_MODEL_SLOT_POSTURE.md` |
| Hermes runtime toolset capability posture | `docs/runtime/UAA_HERMES_RUNTIME_TOOLSET_CAPABILITY_POSTURE.md` |
| Hermes runtime tool registry availability | `docs/runtime/UAA_HERMES_RUNTIME_TOOL_REGISTRY_AVAILABILITY.md` |
| Hermes runtime bounded memory posture | `docs/runtime/UAA_HERMES_RUNTIME_BOUNDED_MEMORY_POSTURE.md` |
| Hermes runtime session search posture | `docs/runtime/UAA_HERMES_RUNTIME_SESSION_SEARCH.md` |
| Hermes runtime progressive skill disclosure | `docs/runtime/UAA_HERMES_RUNTIME_PROGRESSIVE_SKILL_DISCLOSURE.md` |
| Hermes runtime skill write approval gate | `docs/runtime/UAA_HERMES_RUNTIME_SKILL_WRITE_APPROVAL_GATE.md` |
| Hermes runtime skill bundle proposals | `docs/runtime/UAA_HERMES_RUNTIME_SKILL_BUNDLE_PROPOSALS.md` |
| Hermes runtime context references | `docs/runtime/UAA_HERMES_RUNTIME_CONTEXT_REFERENCES.md` |
| Hermes runtime sensitive context guards | `docs/runtime/UAA_HERMES_RUNTIME_SENSITIVE_CONTEXT_GUARDS.md` |
| Hermes runtime checkpoint rollback | `docs/runtime/UAA_HERMES_RUNTIME_CHECKPOINT_ROLLBACK.md` |
| Hermes runtime session lineage | `docs/runtime/UAA_HERMES_RUNTIME_SESSION_LINEAGE.md` |
| Hermes runtime virtual provider MoA | `docs/runtime/UAA_HERMES_RUNTIME_VIRTUAL_PROVIDER_MOA.md` |
| Hermes runtime usage cost analytics | `docs/runtime/UAA_HERMES_RUNTIME_USAGE_COST_ANALYTICS.md` |
| Hermes runtime prompt stability tiers | `docs/runtime/UAA_HERMES_RUNTIME_PROMPT_STABILITY_TIERS.md` |
| Hermes runtime context budget pressure | `docs/runtime/UAA_HERMES_RUNTIME_CONTEXT_BUDGET_PRESSURE.md` |
| Hermes runtime hardline command blocklist | `docs/runtime/UAA_HERMES_RUNTIME_HARDLINE_COMMAND_BLOCKLIST.md` |
| Hermes runtime managed scope policy | `docs/runtime/UAA_HERMES_RUNTIME_MANAGED_SCOPE_POLICY.md` |
| Hermes runtime doctor diagnostics | `docs/runtime/UAA_HERMES_RUNTIME_DOCTOR_DIAGNOSTICS.md` |
| Hermes runtime session continuity | `docs/runtime/UAA_HERMES_RUNTIME_SESSION_CONTINUITY.md` |
| Hermes runtime MCP catalog filtering | `docs/runtime/UAA_HERMES_RUNTIME_MCP_CATALOG_FILTERING.md` |
| Hermes runtime background jobs | `docs/runtime/UAA_HERMES_RUNTIME_BACKGROUND_JOBS.md` |
| Hermes runtime subagent isolation | `docs/runtime/UAA_HERMES_RUNTIME_SUBAGENT_ISOLATION.md` |
| Hermes runtime worktree per agent | `docs/runtime/UAA_HERMES_RUNTIME_WORKTREE_PER_AGENT.md` |
| Hermes runtime LSP diagnostics | `docs/runtime/UAA_HERMES_RUNTIME_LSP_DIAGNOSTICS.md` |
| Hermes runtime preview rail | `docs/runtime/UAA_HERMES_RUNTIME_PREVIEW_RAIL.md` |
| Hermes runtime slash command registry | `docs/runtime/UAA_HERMES_RUNTIME_SLASH_COMMAND_REGISTRY.md` |
| Hermes runtime interrupt redirect | `docs/runtime/UAA_HERMES_RUNTIME_INTERRUPT_REDIRECT.md` |
| Hermes runtime logging profile | `docs/runtime/UAA_HERMES_RUNTIME_LOGGING_PROFILE.md` |
| Hermes runtime result classification | `docs/runtime/UAA_HERMES_RUNTIME_RESULT_CLASSIFICATION.md` |
| Hermes runtime trajectory eval capture | `docs/runtime/UAA_HERMES_RUNTIME_TRAJECTORY_EVAL_CAPTURE.md`, `docs/runtime/hermes_runtime_trajectory_eval_manifest.json`, `docs/schemas/hermes_runtime_trajectory_eval.schema.json`, `reports/hermes_runtime_adoption/trajectory_eval_report_template.md` |
| Hermes runtime voice media posture | `docs/runtime/UAA_HERMES_RUNTIME_VOICE_MEDIA_POSTURE.md` |
| Hermes runtime messaging gateway posture | `docs/runtime/UAA_HERMES_RUNTIME_MESSAGING_GATEWAY_POSTURE.md` |
| Hermes runtime remote execution posture | `docs/runtime/UAA_HERMES_RUNTIME_REMOTE_EXECUTION_POSTURE.md` |
| Hermes runtime plugin metadata posture | `docs/runtime/UAA_HERMES_RUNTIME_PLUGIN_METADATA_POSTURE.md` |
| Hermes runtime skill marketplace posture | `docs/runtime/UAA_HERMES_RUNTIME_SKILL_MARKETPLACE_POSTURE.md` |
| Hermes runtime coding project model Phase 21 | `docs/runtime/UAA_HERMES_RUNTIME_CODING_PROJECT_MODEL.md` |
| UAA runtime parity prompt pack | `docs/runtime/UAA_RUNTIME_PARITY_SCORECARD.md`, `docs/runtime/UAA_RUNTIME_ROUTE_DECISION_BINDING.md`, `docs/runtime/UAA_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md`, `docs/runtime/UAA_RUNTIME_STAGED_ORCHESTRATION_ENGINE.md`, `docs/runtime/UAA_RUNTIME_PREPARED_TURN_LOOP.md`, `docs/runtime/UAA_RUNTIME_ROLE_PROVIDER_EVIDENCE.md`, `docs/runtime/UAA_RUNTIME_ACTION_SIGNED_EVIDENCE.md`, `docs/runtime/UAA_RUNTIME_PARITY_FINAL_HARDENING.md`, `docs/prompts/uaa_runtime_parity/README.md`, `docs/prompts/uaa_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `scripts/verify_uaa_runtime_parity_scorecard.py`, `scripts/verify_uaa_runtime_route_decision_binding.py`, `scripts/verify_uaa_runtime_turn_run_approval_chain.py`, `scripts/verify_uaa_runtime_staged_orchestration.py`, `scripts/verify_uaa_runtime_prepared_turn.py`, `scripts/verify_uaa_runtime_role_provider_evidence.py`, `scripts/verify_uaa_runtime_action_signed_evidence.py`, `scripts/verify_uaa_runtime_parity_final.py`, `scripts/verify_uaa_runtime_parity_prompt_pack.py` |
...
| UAA First-Class Local Boards implementation plan | `docs/implementation/UAA_FIRST_CLASS_BOARDS_IMPLEMENTATION_PLAN.md` (proposed planning-only refinement of ECO-003 for local Trello/kan.bn capability parity, UAA-native projections/governance, migration, portability, interaction quality, and phased acceptance; grants no runtime authority) |
| UAA First-Class CRM implementation plan | `docs/implementation/UAA_FIRST_CLASS_CRM_IMPLEMENTATION_PLAN.md` (planning-only successor to CRM M2 for Sales, Real Estate, Professional Network, Personal Network, and Private Relationships workspaces; grants no new runtime authority) |
| UAA Finance & Compliance FIN-000 direction, merged FIN-001 synthetic protected-book kernel, FIN-002A preview, FIN-002B exact synthetic commit, and FIN-003 read-only review projection plus content-free preview and exact-approved synthetic decision persistence | `docs/product/UAA_FINANCE_COMPLIANCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_FINANCE_FIN000_ACCEPTANCE_MATRIX.md`, `docs/product/UAA_FINANCE_FIN000_INDEPENDENT_REVIEW_PACKET.md`, `docs/product/UAA_FINANCE_FIN000_STATE_ACCESSIBILITY_MATRIX.md`, `docs/product/UAA_FINANCE_WORKFLOW_CASE_STUDY_001.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/product/UAA_FINANCE_FIN001_ACTIVATION_RECORD.md`, `docs/product/UAA_FINANCE_FIN001_SYNTHETIC_KERNEL.md`, `docs/product/UAA_FINANCE_FIN002_SYNTHETIC_IMPORT_PREVIEW.md`, `docs/product/UAA_FINANCE_FIN003_SYNTHETIC_REVIEW_PROJECTION.md`, `docs/product/UAA_FINANCE_FIN003_SYNTHETIC_REVIEW_DECISION_PREVIEW.md`, `docs/product/UAA_FINANCE_FIN003_SYNTHETIC_REVIEW_DECISION_PERSISTENCE.md`, `docs/product/finance_fin001_activation_v1.json`, `docs/schemas/finance_fin001_activation_v1.schema.json`, `scripts/verify_fin001_activation.py`, `scripts/verify_fin001_synthetic_kernel.py`, `scripts/verify_fin002_synthetic_import_preview.py`, `scripts/verify_fin002_synthetic_import_commit.py`, `scripts/verify_fin003_synthetic_review_projection.py`, `scripts/verify_fin003_synthetic_review_decision_preview.py`, `scripts/verify_fin003_review_decision_persistence.py`, `docs/implementation/UAA_FINANCE_COMPLIANCE_IMPLEMENTATION_PLAN.md`, `docs/security/UAA_FINANCE_COMPLIANCE_THREAT_MODEL.md`, `docs/decisions/ADR-0063-finance-protected-local-data-boundary.md`, `docs/roadmap/UAA_FINANCE_COMPLIANCE_QUEUE_INSERTION.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/README.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/REVIEW_GALLERY.md` (FIN-002 import/commit accepts only exact allowlisted synthetic fixtures; FIN-003 projects only a committed synthetic `FinanceSnapshot`, previews content-free consequences and separately persists exact-approved synthetic dispositions with compensating undo through Core/CLI; independent real-data promotion remains pending, while categorization, arbitrary file input, OCR, account connection, accountant access, payment, filing, advice, and supported deployment stay excluded) |
| UAA coherent app ecosystem implementation plan | `docs/implementation/UAA_COHERENT_APP_ECOSYSTEM_IMPLEMENTATION_PLAN.md` (full-vision, planning-only program for standalone-quality Calendar, Tasks, Boards, CRM, Inbox, Social, Finance & Compliance, Today, Organizer, and shared governed integration; grants no new runtime authority) |
| Founder functional adoption and post-adoption parity | `docs/implementation/FOUNDER_FUNCTIONAL_ADOPTION_PROGRAM.md`, `docs/control_center/Q32_CRM_FUNCTIONAL_ADOPTION.md`, `docs/control_center/Q33_FOUNDER_OPERATING_LOOP_ADOPTION.md`, `docs/control_center/Q34_NEWS_SOURCE_INTELLIGENCE_ADOPTION.md`, `docs/evals/UAA_FINAL_GOATCITADEL_COMPARISON_PLAN.md`, `docs/evals/UAA_POST_ADOPTION_HERMES_OPENCLAW_PARITY_PLAN.md`, `docs/roadmap/UAA_DEVELOPER_QUEUE_V2_MANIFEST.json` (Q31 directly observed GoatCitadel and UAA chat/operator behavior; Q32 and Q33 are terminal; Q34 is the active News adoption item; Q35-Q36 then prove vertical and cross-module use; Q37 rechecks the adopted product against exact current Hermes/OpenClaw functional and visual behavior; grants no new external or production authority) |
| UAA Social Media Intelligence private-dogfood milestone completion and fail-closed independent-promotion evidence | `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/product/social_read_only_foundation_promotion_v1.json`, `docs/schemas/social_read_only_foundation_promotion_v1.schema.json`, `scripts/verify_social_read_only_foundation_profile.py`, `src/ultimate_ai_agent/core/crm/social_projection.py`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md` (Work Board, Communications, and CRM own strict read-only projections; Q25 is complete for local private dogfood while independent human promotion remains pending; grants no connector runtime, publishing, reply, scheduling write, provider/model call, background sync, or production authority) |
| Q30 governed social publishing proposal and dry-run implementation | `docs/implementation/UAA_SOCIAL_PUBLISHING_IMPLEMENTATION_PLAN.md`, `docs/product/UAA_SOCIAL_PUBLISHING_Q30_ACCEPTANCE_MATRIX.md`, `src/ultimate_ai_agent/core/social_publishing/`, `scripts/dev/uaa_social_publishing.py`, `scripts/verify_social_publishing_q30.py`, `tests/test_social_publishing_q30.py` (P0-P6 content-free synthetic fixture contracts, exact review binding, deterministic independent settlements, concurrent exact replay, failed-only retry, unknown reconciliation, protected GET-only API, readable Studio UI, and finite acceptance freeze are complete for the local proposal/dry-run tier; grants no account, credential, connector, network, upload, scheduler, platform write, publishing, or production authority) |
| ECO-000 accepted ecosystem foundation | `src/ultimate_ai_agent/core/ecosystem/`, `docs/decisions/ADR-0054-canonical-application-object-ownership.md` through `docs/decisions/ADR-0061-ecosystem-shell-navigation-and-launch.md`, `docs/architecture/ECO_000_EXISTING_STATE_AND_MIGRATION_INVENTORY.md`, `docs/architecture/ECO_000_ROUTE_AND_INFORMATION_ARCHITECTURE.md`, `docs/security/ECO_000_APP_ECOSYSTEM_THREAT_MODEL.md`, `docs/product/ECO_000_APP_ACCEPTANCE_MATRIX.md`, `docs/product/eco_000_app_acceptance.json`, `docs/design/ecosystem_north_star/README.md`, `docs/quality/ECO_000_QUALITY_BUDGETS.md`, `scripts/verify_eco_000_ecosystem_contracts.py` (accepted contracts/design criteria only; apps, storage, routes, connectors, and authority remain unimplemented) |
| ECO-001 shared local-data foundation | `docs/architecture/ECO_001_SHARED_LOCAL_DATA_FOUNDATION.md`, `src/ultimate_ai_agent/core/ecosystem/local_data.py`, `scripts/verify_eco_001_local_data.py`, `tests/test_eco_001_local_data.py` (trusted-time approval-bound encrypted repository, encrypted exact replay and complete receipt integrity, tombstoned record refs, reader-safe key rotation, canonical schema shape/transactional initialization, trusted destination refs, atomic local unit of work, blind-index search/rebuild, deep size-bounded backup/restore, archive/delete, and bounded read-only migration preview; no production key/path backend, app cutover, route, connector, cloud sync, or production authority) |
| ECO-002 canonical Tasks and mission ownership | `docs/architecture/ECO_002_CANONICAL_TASKS_AND_MISSION_OWNERSHIP.md`, `docs/decisions/ADR-0064-canonical-tasks-and-mission-ownership.md`, `src/ultimate_ai_agent/core/ecosystem/tasks.py`, `scripts/verify_eco_002_tasks.py`, `tests/test_eco_002_tasks.py` (encrypted canonical task truth, exact Task-specific authority and replay, lifecycle/views/dependencies, explicit recurrence, mission-owned execution refs, and bounded read-only Founder Loop compatibility preview; no product cutover, route/UI, production key backend, scheduler, external task write, mission execution, or production authority) |
| ECO-003 reusable Boards and Task projections | `docs/architecture/ECO_003_REUSABLE_BOARDS_AND_TASK_PROJECTIONS.md`, `docs/decisions/ADR-0065-reusable-boards-and-task-projections.md`, `src/ultimate_ai_agent/core/ecosystem/boards.py`, `scripts/verify_eco_003_boards.py`, `tests/test_eco_003_boards.py`, `tests/test_eco_003_verifier.py` (encrypted versioned Boards, lanes, standalone cards, deterministic ordering, WIP, saved filters, templates, protected undo, and live ref-only canonical Task projections; no API route, CLI command, UI, Work Board cutover, mapped Task mutation, cloud collaboration, external runtime, or production authority) |
| ECO-004 standalone local Calendar | `docs/architecture/ECO_004_STANDALONE_LOCAL_CALENDAR.md`, `docs/decisions/ADR-0066-standalone-local-calendar.md`, `src/ultimate_ai_agent/core/ecosystem/calendar.py`, `scripts/verify_eco_004_calendar.py`, `tests/test_eco_004_calendar.py`, `tests/test_eco_004_verifier.py` (encrypted Calendar Sets, local calendars/events, recurrence, bounded occurrences, IANA time zones and DST, day/week/month/agenda views, overlap conflicts, intent-only reminders, ref-only Task time blocks, typed portability, receipts, and protected undo; no API route, CLI command, UI, notification delivery, account adapter, external calendar write, or production authority) |
| ECO-005 first-class private CRM foundation | `docs/architecture/ECO_005_FIRST_CLASS_PRIVATE_CRM.md`, `docs/security/ECO_005_PRIVATE_CRM_THREAT_MODEL.md`, `docs/decisions/ADR-0067-first-class-private-crm.md`, `src/ultimate_ai_agent/core/crm/private_repository.py`, `scripts/verify_eco_005_private_crm.py`, `tests/test_eco_005_private_crm.py`, `tests/test_eco_005_verifier.py` (accepted bounded persistence threat review; encrypted shared identity and isolated CRM workspace contexts, relationships, activities, follow-ups, opportunity metadata, protected undo, and live exact Board-card pipeline projections; Private Relationships excluded from shared surfaces by default; no migration/cutover, route/CLI/UI, external CRM/account sync, connector sends/writes, provider/model/browser/background runtime, public release, or production authority) |
| ECO-006 Today and Morning Briefing projection | `docs/architecture/ECO_006_TODAY_AND_MORNING_BRIEFING.md`, `docs/decisions/ADR-0068-today-and-morning-briefing-projection.md`, `src/ultimate_ai_agent/core/ecosystem/today.py`, `scripts/verify_eco_006_today.py`, `tests/test_eco_006_today.py`, `tests/test_eco_006_verifier.py` (accepted bounded deterministic projection over canonical source results with explicit owner/ref provenance, visible ordering, freshness and missing-source posture, surface-specific CRM privacy, and proposal-only carry-forward; existing Founder Loop Today/Briefing remains compatibility truth; no storage/cutover, route/CLI/UI, refresh, connector, mutation, notification, provider/model/browser/background runtime, public release, or production authority) |
| ECO-007 Inbox and source-artifact workbench | `docs/architecture/ECO_007_INBOX_SOURCE_ARTIFACT_WORKBENCH.md`, `docs/decisions/ADR-0069-inbox-source-artifact-workbench.md`, `src/ultimate_ai_agent/core/ecosystem/inbox.py`, `scripts/verify_eco_007_inbox.py`, `tests/test_eco_007_inbox.py`, `tests/test_eco_007_verifier.py` (accepted encrypted manual/synthetic source repository with content-free plans, exact approval/replay, workspace-bound triage/links/threads, blind-index search, archive/retention posture, and reviewed proposal-only Today handoff; existing Founder Loop Inbox surfaces remain compatibility truth; no connector/account/file read, route/CLI/UI, send/write, cross-app execution, provider/model/browser/subprocess/background runtime, public release, or production authority) |
| ECO-008 EntityLink and ChangeSet engine | `docs/architecture/ECO_008_ENTITY_LINK_AND_CHANGESET_ENGINE.md`, `docs/decisions/ADR-0071-entitylink-and-changeset-engine.md`, `src/ultimate_ai_agent/core/ecosystem/changesets.py`, `scripts/verify_eco_008_changesets.py`, `tests/test_eco_008_changesets.py`, `tests/test_eco_008_verifier.py` (accepted typed encrypted link persistence plus content-free field diffs, dependency-ordered exact existing-record Task/Board/Calendar local transactions, keyed conflict/replay receipts, encrypted restart-safe rollback ledger, and separately approved undo; external outcomes and compensation remain projection-only; no CRM/Inbox mutation adapter, create/delete/lifecycle ChangeSet, route/CLI/UI, connector/external write, provider/model/browser/background runtime, public release, or production authority) |
| ECO-009 exact read-only connector platform | `docs/architecture/ECO_009_EXACT_READ_ONLY_CONNECTOR_PLATFORM.md`, `src/ultimate_ai_agent/core/connectors/read_only_platform.py`, `scripts/inspect_eco_009_read_only_connectors.py`, `scripts/verify_eco_009_read_only_connectors.py`, `tests/test_eco_009_read_only_connectors.py`, `tests/test_eco_009_verifier.py` (accepted first exact caller-supplied calendar metadata snapshot adapter with bounds, cursors, provenance, retention, bounded replay binding, revocation, irreversible in-instance safe-disable, rate limits, CLI inspection posture, and truthful Source Readiness UI derived from its existing backend calendar contract; no live account, auth, external read, network, background sync, raw content, write, or production authority) |
| ECO-010 deterministic proposal intelligence | `docs/architecture/ECO_010_PROPOSAL_INTELLIGENCE.md`, `src/ultimate_ai_agent/core/ecosystem/proposals.py`, `src/ultimate_ai_agent/api/founder_loop.py`, `docs/api/openapi_contract.md`, `docs/api/route_inventory.md`, `scripts/inspect_eco_010_proposals.py`, `scripts/verify_queue_v2_q27_proposal_intelligence.py`, `tests/test_queue_v2_q27_proposal_intelligence.py` (bounded cited proposal-only event, task, person, commitment, and meeting candidates with source-revision, privacy, uncertainty, canonical-owner posture, and one protected validation-only API route; no source read, model authority, ChangeSet, target record, or direct commit) |
| Q28 proposal-only Autocorrect Controls | `docs/architecture/Q28_AUTOCORRECT_CONTROLS.md`, `src/ultimate_ai_agent/core/ecosystem/corrections.py`, `src/ultimate_ai_agent/api/founder_loop.py`, `scripts/inspect_autocorrect_controls.py`, `scripts/verify_q28_autocorrect_controls.py`, `apps/control-center/src/components/AutocorrectControlPanel.tsx`, `tests/test_q28_autocorrect_controls.py` (content-free exact field-diff review for accepted ECO-008 targets with stale revision, confidence, safe-disable, idempotency conflict, rejection/supersession learning, and rollback-readiness truth; no canonical mutation, ChangeSet creation, approval grant, rollback execution, model call, or external write) |
| Q29 governed self-improvement proposal loop | `docs/architecture/Q29_GOVERNED_SELF_IMPROVEMENT.md`, `src/ultimate_ai_agent/core/ecosystem/improvements.py`, `scripts/inspect_governed_improvement.py`, `scripts/verify_q29_governed_improvement.py`, `tests/test_q29_governed_improvement.py` (content-free revision-bound evidence sources, source-specific rights, deterministic proposals, independent human review, rollback requirements, and verified outcome receipts; no self-modifying code, patch creation, training, approval grant, automatic promotion, Git publication, merge, or external write) |
| Q24 News and Signals backend read model | `docs/control_center/NEWS_AND_SIGNALS_MODULE_PLAN.md`, `src/ultimate_ai_agent/core/news_signals/read_model.py`, `scripts/inspect_news_signals.py`, `scripts/verify_queue_v2_q24_news_signals.py`, `apps/control-center/src/components/NewsSignalsPreviewPanel.tsx`, `tests/test_queue_v2_q24_news_signals.py` (backend-owned durable local projection from already-redacted artifacts with source readiness, provenance, freshness, clustering, deterministic explainable ranking, conflicts, and bounded Today and Morning Briefing candidates; no live fetch, account, background poll, model summary, connector write, recommendation, action, or production authority) |
| Messenger Matrix MSG-MX-001 accepted design gate | `docs/design/control_center_north_star/UAA_MESSENGER_MATRIX_RENDER_ACCEPTANCE.md`, `docs/decisions/ADR-0062-messenger-matrix-client-and-data-boundaries.md`, `docs/security/UAA_MESSENGER_MATRIX_THREAT_MODEL.md`, `docs/connectors/MESSENGER_MATRIX_DESIGN_AUTHORITY_MATRIX.md`, `scripts/verify_msg_mx_001_design_gate.py`, `tests/test_msg_mx_001_design_gate.py` (desktop target/design evidence only; no Matrix SDK, route, network, account, credential, sync, message, media, call, or runtime authority) |
| Messenger Matrix MSG-MX-003 communications contracts | `src/ultimate_ai_agent/core/communications`, `src/ultimate_ai_agent/api/communications.py`, `scripts/dev/uaa_communications.py`, `scripts/verify_msg_mx_003_communications_contracts.py`, `tests/test_msg_mx_003_communications_contracts.py`, `tests/test_msg_mx_003_communications_api_cli.py` (backend-owned safe-ref inspection and disabled adapter only; no Matrix runtime authority) |
| Messenger Matrix MSG-MX-004 disposable local harness | `docs/connectors/MESSENGER_MATRIX_LOCAL_HARNESS.md`, `src/ultimate_ai_agent/core/communications/matrix_harness`, `packaging/messenger-matrix-harness`, `src/ultimate_ai_agent/api/communications.py`, `scripts/dev/uaa_communications.py`, `scripts/verify_msg_mx_004_local_synapse_harness.py`, `tests/test_msg_mx_004_matrix_harness_authority.py`, `tests/test_msg_mx_004_matrix_harness_backend.py`, `tests/test_msg_mx_004_matrix_harness_api_cli.py` (six exact loopback development lanes only; no connector/session/message/crypto/UI/public/production authority) |
| Messenger Matrix MSG-MX-005 discovery/session boundary | `docs/connectors/MESSENGER_MATRIX_SESSION.md`, `src/ultimate_ai_agent/core/communications/matrix_session`, `integrations/matrix-client-adapter`, `scripts/verify_msg_mx_005_matrix_session.py`, `tests/test_msg_mx_005_matrix_session_authority.py`, `tests/test_msg_mx_005_matrix_session_dispatch.py`, `tests/test_msg_mx_005_matrix_session_node_integration.py` (two exact read lanes implemented; eight credential/browser/account/session mutations blocked; no sync/message/crypto/media/UI/public/production authority) |
| Messenger Matrix MSG-MX-006 read-only sync boundary | `docs/connectors/MESSENGER_MATRIX_READ_ONLY_SYNC.md`, `src/ultimate_ai_agent/core/communications/matrix_sync`, `tools/macos/matrix-protected-cache-helper`, `scripts/verify_msg_mx_006_read_only_sync.py`, `tests/test_msg_mx_006_matrix_sync_authority.py`, `tests/test_msg_mx_006_matrix_sync_cache.py`, `tests/test_msg_mx_006_matrix_sync_transport.py`, `tests/test_msg_mx_006_matrix_sync_api_cli.py` (twelve exact authority lanes declared; two GET transports and protected-cache/key primitives loopback-tested; ten canonical dispatch executors uncomposed and fail closed; live account sync remains configuration-required; fixture content remains synthetic; sends/writes/crypto/media/public/production authority blocked) |
| Messenger Matrix MSG-MX-007 crypto authority boundary | `docs/connectors/MESSENGER_MATRIX_CRYPTO_RECOVERY.md`, `src/ultimate_ai_agent/core/communications/matrix_crypto`, `src/ultimate_ai_agent/api/communications.py`, `scripts/dev/uaa_communications.py`, `scripts/verify_msg_mx_007_matrix_crypto.py`, `tests/test_msg_mx_007_matrix_crypto_authority.py`, `tests/test_msg_mx_007_matrix_crypto_api_cli.py` (seventeen exact authority lanes and content-free posture/proposal parity; persistent Rust-crypto broker adapter required; all live key/trust/backup/recovery/reset operations blocked; Element interoperability externally required) |
| Messenger Matrix MSG-MX-008 manual messaging boundary | `docs/connectors/MESSENGER_MATRIX_MANUAL_MESSAGING.md`, `src/ultimate_ai_agent/core/communications/matrix_messaging`, `integrations/matrix-rust-broker`, `src/ultimate_ai_agent/api/communications.py`, `scripts/dev/uaa_communications.py`, `scripts/verify_msg_mx_008_manual_messaging.py`, `tests/test_msg_mx_008_matrix_messaging_contracts.py`, `tests/test_msg_mx_008_matrix_messaging_api_cli.py` (fifteen exact human-commanded messaging/outbox/notification lanes; loopback-only native executor and encrypted outbox implemented; default configuration required; remote/AI/autonomous sends denied; Element interoperability externally required) |
| Messenger Matrix MSG-MX-009 rooms, encrypted search, and bounded media boundary | `docs/connectors/MESSENGER_MATRIX_ROOMS_SEARCH_MEDIA.md`, `src/ultimate_ai_agent/core/communications/matrix_rooms_media`, `integrations/matrix-rust-broker`, `src/ultimate_ai_agent/api/communications.py`, `scripts/dev/uaa_communications.py`, `scripts/verify_msg_mx_009_rooms_search_media.py`, `tests/test_msg_mx_009_rooms_search_media_contracts.py`, `tests/test_msg_mx_009_rooms_search_media_api_cli.py` (twenty exact request-scoped room/admin/search/media lanes; encrypted local index and descriptor-bound app-owned media lifecycle implemented; default configuration required; no standing, multi-account, remote, autonomous, public, or production authority; Element interoperability externally required) |
| Messenger Matrix MSG-MX-010 governed intelligence and review-only proposals | `docs/connectors/MESSENGER_MATRIX_INTELLIGENCE_PROPOSALS.md`, `src/ultimate_ai_agent/core/communications/matrix_intelligence`, `src/ultimate_ai_agent/api/communications.py`, `scripts/dev/uaa_communications.py`, `scripts/verify_msg_mx_010_intelligence_proposals.py`, `tests/test_msg_mx_010_intelligence_contracts.py`, `tests/test_msg_mx_010_intelligence_api_cli.py` (six exact request-scoped local policy/context/proposal lanes; transient content-free context manifests and redacted proposal metadata only; provider invocation, attachment analysis, autonomous send, action execution, context injection, and automatic Memory remain blocked) |
| Messenger Matrix MSG-MX-011 reliability and security hardening | `docs/connectors/MESSENGER_MATRIX_HARDENING.md`, `src/ultimate_ai_agent/core/communications/matrix_hardening`, `src/ultimate_ai_agent/core/communications/matrix_sync`, `src/ultimate_ai_agent/core/communications/matrix_messaging`, `scripts/verify_msg_mx_011_messenger_hardening.py`, `tests/test_msg_mx_011_messenger_hardening.py` (no new runtime lane; cumulative cache/outbox bounds, typed low-disk failure, and content-free API/CLI/desktop posture; migration and persistent multi-device ownership blocked, localization partial, Element interoperability externally required) |
| Messenger Matrix MSG-MX-012 integrated acceptance packet | `docs/connectors/MESSENGER_MATRIX_ACCEPTANCE_PACKET.md`, `scripts/verify_msg_mx_012_messenger_acceptance.py`, `tests/test_msg_mx_012_messenger_acceptance.py` (no new runtime lane; finite redacted review of thirteen milestones, fifteen desktop surfaces, required recovery/failure scenarios, and API/CLI/macOS parity; persistent crypto, multi-device recovery, enrolled remote runtime, and Element interoperability remain blocked or externally required) |
| UAA developer-feedback prompt pack | `docs/implementation/UAA_DEVELOPER_FEEDBACK_IMPLEMENTATION_PLAN.md`, `docs/prompts/uaa_developer_feedback/README.md`, `scripts/verify_uaa_developer_feedback_prompt_pack.py`, `tests/test_uaa_developer_feedback_prompt_pack.py` (stored implementation prompts only; capture, disclosure, Codex launch, repository mutation, Git, and PR authority remain separately gated) |
| Local developer work coordinator | `docs/developer/LOCAL_DEVELOPER_WORK_COORDINATOR.md`, `docs/roadmap/UAA_DEVELOPER_QUEUE_V2_MANIFEST.json`, `scripts/dev/uaa_developer_orchestrator/`, `scripts/dev/uaa_developer_queue.py`, `tests/test_developer_orchestrator.py` (separate local developer coordination plane: authoritative Q00-Q37 admission and starvation health, exact selective admission plus prior-fingerprint-bound queued-task amendment for reviewed extensions, semantic contract-drift reporting, a three-claim global WIP cap with one claim per named lane, registered-node claims and heartbeats, isolated-worktree metadata, terminal scope-packet archive gate, verifier/merge gates, and fixed read-only Git hygiene scouting; no agent launch, Git mutation, remote dispatch, or UAA product-runtime authority) |
...
| Durable system capability map | `docs/architecture/SYSTEM_CAPABILITY_MAP.md`, `src/ultimate_ai_agent/core/system_map/`, `scripts/dev/uaa_system_map.py`, `tests/test_system_map.py` (content-addressed canonical ownership, surface, authority-lane, dependency, conflict, route/CLI, and proposal-only opportunity graph; no authority or execution) |
...
| Verification architecture, review convergence, maintainability, and independent hardening | `docs/verification/RISK_BASED_VERIFICATION_ARCHITECTURE.md`, `docs/verification/FAST_LOCAL_VERIFICATION.md`, `docs/verification/REVIEW_CONVERGENCE_POLICY.md`, `docs/verification/TEST_CORPUS_MODERNIZATION.md`, `docs/verification/test_corpus_retirements.json`, `docs/verification/PRODUCT_HARDENING_EVIDENCE_GATE.md`, `docs/verification/milestone_status_manifest.json`, `docs/verification/verification_maintainability_policy.json` |
...
| Medical knowledge and local Knowledge Workbench | `docs/knowledge/MEDICAL_KNOWLEDGE_BASELINE.md`, `docs/knowledge/KNOWLEDGE_DUMP.md`, `docs/architecture/Q18_KNOWLEDGE_WORKBENCH_HARDENING.md`, `docs/decisions/ADR-0070-knowledge-workbench-hardening.md`, `src/ultimate_ai_agent/core/medical_knowledge/`, `src/ultimate_ai_agent/core/knowledge_dump/`, `scripts/dev/uaa_knowledge.py`, `scripts/verify_queue_v2_q18_knowledge_workbench.py`, `tests/test_medical_knowledge_catalog.py`, `tests/test_knowledge_dump.py`, `tests/test_knowledge_workbench_hardening.py`, `tests/test_knowledge_workbench_verifier.py` (15 registered medical source records plus exact-approved local TXT/Markdown/HTML/EPUB ingestion, navigation, lifecycle, rights/OCR review, permanent removal, filtered FTS5 retrieval, truthful encryption posture, and exact operator-selected cited context; PDF/automatic OCR, network ingestion, automatic Chat injection, application-level encryption, embeddings/vector search, model training, diagnosis, prescribing, and clinical authority remain blocked) |
...
deterministic proposal refs, and exact `contacts/write`-gated local mutation
receipts while keeping connector runtime, connector writes, external CRM
writes, account sync, sends, calendar writes, provider/model calls, live web,
browser runtime, public beta, public release, production readiness, and
...
Plane in `docs/control_center/MODEL_PROVIDER_CONTROL_PLANE.md`, and the
...
(`docs/control_center/FCC_V1_007_PROMOTION_AND_PROOF_LANE.md`), and
FCC-THREAD-001 Unified Work Thread Read Model
(`docs/control_center/FCC_THREAD_001_UNIFIED_WORK_THREAD.md`) for backend-owned
safe-ref thread readability without runtime authority.
...
docs/verification/REVIEW_CONVERGENCE_POLICY.md
...
docs/runtime/UAA_AUTHORITY_MISSION_WORKER_V1.md
...
docs/runtime/UAA_RUNTIME_PREPARED_TURN_LOOP.md
docs/runtime/UAA_RUNTIME_ACTION_SIGNED_EVIDENCE.md
docs/runtime/UAA_RUNTIME_PARITY_FINAL_HARDENING.md
...
docs/runtime/UAA_HERMES_RUNTIME_STREAMING_PROGRESS.md
docs/runtime/UAA_HERMES_RUNTIME_PROFILE_ISOLATION.md
