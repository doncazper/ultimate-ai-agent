...
| UAA Finance & Compliance FIN-000 direction, merged FIN-001 synthetic protected-book kernel, FIN-002A preview, and FIN-002B exact synthetic commit | `docs/product/UAA_FINANCE_COMPLIANCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_FINANCE_FIN000_ACCEPTANCE_MATRIX.md`, `docs/product/UAA_FINANCE_FIN000_INDEPENDENT_REVIEW_PACKET.md`, `docs/product/UAA_FINANCE_FIN000_STATE_ACCESSIBILITY_MATRIX.md`, `docs/product/UAA_FINANCE_WORKFLOW_CASE_STUDY_001.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/product/UAA_FINANCE_FIN001_ACTIVATION_RECORD.md`, `docs/product/UAA_FINANCE_FIN001_SYNTHETIC_KERNEL.md`, `docs/product/UAA_FINANCE_FIN002_SYNTHETIC_IMPORT_PREVIEW.md`, `docs/product/finance_fin001_activation_v1.json`, `docs/schemas/finance_fin001_activation_v1.schema.json`, `scripts/verify_fin001_activation.py`, `scripts/verify_fin001_synthetic_kernel.py`, `scripts/verify_fin002_synthetic_import_preview.py`, `scripts/verify_fin002_synthetic_import_commit.py`, `docs/implementation/UAA_FINANCE_COMPLIANCE_IMPLEMENTATION_PLAN.md`, `docs/security/UAA_FINANCE_COMPLIANCE_THREAT_MODEL.md`, `docs/decisions/ADR-0063-finance-protected-local-data-boundary.md`, `docs/roadmap/UAA_FINANCE_COMPLIANCE_QUEUE_INSERTION.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/README.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/REVIEW_GALLERY.md` (preview and commit accept allowlisted synthetic fixtures only; independent real-data promotion remains pending, while arbitrary file input, OCR, account connection, accountant access, payment, filing, advice, and supported deployment stay excluded) |
