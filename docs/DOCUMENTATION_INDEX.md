...
v0.37.3 repairs active roadmap label alignment after v0.37.2. Active roadmap
sources consistently keep v0.38.0 / M34 as Broader File Capability Review,
planned/provisional, and documentation-integrity checks now guard against
active next-milestone label disagreement.

## Release Notes Index

Current release notes: `docs/release_notes/v0_37_3.md`
