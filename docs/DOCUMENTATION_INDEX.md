...
`docs/control_center/PROVIDER_CREDENTIAL_READINESS_COST_BINDING.md`, backed by
...
output authority, no unknown paid-cost bypass, and no callable runtime
authority.
