...
active M34-M60 sequence. v0.47.0 is the current active baseline after
implementing M43 Mobile API Boundary, Read-Only as contract-only
planning/docs/contracts/verifier work. Active roadmap sources consistently
...
M44-M60 planned/provisional, and rely on documentation-integrity checks to guard
against superseded-roadmap drift, stale current-baseline labels, mobile product
contract drift, and read-only mobile API boundary drift.

## Release Notes Index

Current release notes: `docs/release_notes/v0_47_0.md`
