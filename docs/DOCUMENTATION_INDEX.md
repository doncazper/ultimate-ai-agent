...
active M34-M60 sequence. v0.38.2 is the current active baseline after repairing
M34 active-baseline currentness labels. Active roadmap sources consistently keep
v0.38.0 / M34 as Broader File Capability Review, keep M34
planning/docs/verifier only, mark M35-M60 planned/provisional, and rely on
documentation-integrity checks to guard against superseded-roadmap drift and
stale current-baseline labels.

## Release Notes Index

Current release notes: `docs/release_notes/v0_38_2.md`
