...
| Social Media Intelligence deferred implementation prompt | `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md`, `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/backlog/codex_recommendation_log.md`, `docs/kanban/founder_command_center_board.md` |
...
| UAA Finance & Compliance FIN-000 planning program | `docs/product/UAA_FINANCE_COMPLIANCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_FINANCE_WORKFLOW_CASE_STUDY_001.md`, `docs/implementation/UAA_FINANCE_COMPLIANCE_IMPLEMENTATION_PLAN.md`, `docs/security/UAA_FINANCE_COMPLIANCE_THREAT_MODEL.md`, `docs/decisions/ADR-0063-finance-protected-local-data-boundary.md`, `docs/product/UAA_FINANCE_FIN000_ACCEPTANCE_MATRIX.md`, `docs/product/UAA_FINANCE_FIN000_INDEPENDENT_REVIEW_PACKET.md`, `docs/product/UAA_FINANCE_FIN000_STATE_ACCESSIBILITY_MATRIX.md`, `docs/roadmap/UAA_FINANCE_COMPLIANCE_QUEUE_INSERTION.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/README.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/REVIEW_GALLERY.md` (planning-only first-party local Finance direction, privacy-safe workflow, protected-data boundary, schema/adapter/state decisions, deferred queue placement, locked render acceptance ledger, gallery, state/accessibility matrix, and independent review packet; grants no account connection, accountant access, payment, filing, advice, or runtime authority) |
...
| UAA Social Media Intelligence product contract and partial read-only foundation profile | `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md` (accepted planning direction plus a partial implementation profile: Work Board owns a strict read-only `Social Content` saved projection and Communications owns a reviewed local read projection with API/CLI and Control Center parity; Q25 remains deferred pending Work Board visual, CRM, Communications visual, and bound profile acceptance; grants no connector runtime, publishing, reply, scheduling write, provider/model call, background sync, or production authority) |
