...
| Control Center UI/UX specification and north-star design files | `docs/design/CONTROL_CENTER_UI_UX_SPEC.md`, `docs/design/control_center_north_star/README.md`, `docs/design/control_center_north_star/APP_SHELL_BASELINE.md`, `docs/design/control_center_north_star/SURFACE_COVERAGE.md`, `docs/design/control_center_north_star/RENDER_MANIFEST.md`, `docs/design/control_center_north_star/RENDER_VARIATION_MATRIX.md` |
