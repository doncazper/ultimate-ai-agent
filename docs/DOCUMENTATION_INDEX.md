...
| UAA Finance & Compliance FIN-000 direction and FIN-001 synthetic protected-book candidate | `docs/product/UAA_FINANCE_COMPLIANCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_FINANCE_FIN000_ACCEPTANCE_MATRIX.md`, `docs/product/UAA_FINANCE_FIN000_INDEPENDENT_REVIEW_PACKET.md`, `docs/product/UAA_FINANCE_FIN000_STATE_ACCESSIBILITY_MATRIX.md`, `docs/product/UAA_FINANCE_WORKFLOW_CASE_STUDY_001.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/product/UAA_FINANCE_FIN001_ACTIVATION_RECORD.md`, `docs/product/UAA_FINANCE_FIN001_SYNTHETIC_KERNEL.md`, `docs/product/finance_fin001_activation_v1.json`, `docs/schemas/finance_fin001_activation_v1.schema.json`, `scripts/verify_fin001_activation.py`, `scripts/verify_fin001_synthetic_kernel.py`, `docs/implementation/UAA_FINANCE_COMPLIANCE_IMPLEMENTATION_PLAN.md`, `docs/security/UAA_FINANCE_COMPLIANCE_THREAT_MODEL.md`, `docs/decisions/ADR-0063-finance-protected-local-data-boundary.md`, `docs/roadmap/UAA_FINANCE_COMPLIANCE_QUEUE_INSERTION.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/README.md`, `docs/design/control_center_north_star/renders/finance-compliance-v1/REVIEW_GALLERY.md` (implementation candidate is synthetic-only and still needs protected merge and Queue V2 completion; independent promotion remains pending, while real-data, account connection, accountant access, payment, filing, advice, and supported deployment stay excluded) |
...
| UAA Social Media Intelligence product contract and founder-approved private-dogfood direction | `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md` (Work Board and Communications own strict read-only projections and the founder accepted the displayed direction for iterative private dogfood; Q25 remains deferred pending the CRM relationship projection and independent promotion profile; grants no connector runtime, publishing, reply, scheduling write, provider/model call, background sync, or production authority) |
