...
| UAA Social Media Intelligence product contract, founder-approved private-dogfood direction, and fail-closed foundation promotion evidence | `docs/product/UAA_SOCIAL_MEDIA_INTELLIGENCE_PRODUCT_CONTRACT.md`, `docs/product/UAA_SOCIAL_READ_ONLY_FOUNDATION_PROFILE.md`, `docs/product/UAA_PRIVATE_DOGFOOD_DIRECTION_ACCEPTANCE.md`, `docs/product/social_read_only_foundation_promotion_v1.json`, `docs/schemas/social_read_only_foundation_promotion_v1.schema.json`, `scripts/verify_social_read_only_foundation_profile.py`, `src/ultimate_ai_agent/core/crm/social_projection.py`, `docs/design/control_center_north_star/renders/social-media-v1/README.md`, `docs/prompts/implement_social_media_intelligence_after_foundation_gates.prompt.md` (Work Board, Communications, and CRM own strict read-only projections; Q25 remains deferred pending independent human promotion; grants no connector runtime, publishing, reply, scheduling write, provider/model call, background sync, or production authority) |
