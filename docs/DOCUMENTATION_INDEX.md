...
| UAA GoatCitadel runtime parity baseline | `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_SCORECARD.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ROUTE_DECISION_BINDING.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_STAGED_ORCHESTRATION_ENGINE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_PREPARED_TURN_LOOP.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ROLE_PROVIDER_EVIDENCE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ACTION_SIGNED_EVIDENCE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_FINAL_HARDENING.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/README.md`, `scripts/verify_uaa_goatcitadel_runtime_parity_scorecard.py`, `scripts/verify_uaa_goatcitadel_runtime_route_decision_binding.py`, `scripts/verify_uaa_goatcitadel_runtime_turn_run_approval_chain.py`, `scripts/verify_uaa_goatcitadel_runtime_staged_orchestration.py`, `scripts/verify_uaa_goatcitadel_runtime_prepared_turn.py`, `scripts/verify_uaa_goatcitadel_runtime_role_provider_evidence.py`, `scripts/verify_uaa_goatcitadel_runtime_action_signed_evidence.py`, `scripts/verify_uaa_goatcitadel_runtime_parity_final.py`, `tests/test_uaa_goatcitadel_runtime_parity_scorecard.py`, `tests/test_route_decision_binding.py`, `tests/test_turn_run_approval_chain.py`, `tests/test_staged_orchestration_engine.py`, `tests/test_prepared_turn.py`, `tests/test_role_provider_evidence.py`, `tests/test_runtime_action_signed_evidence.py`, `tests/test_runtime_parity_loop_read_model.py` |
...
| Control Center north-star design files | `docs/design/control_center_north_star/README.md`, `docs/design/control_center_north_star/APP_SHELL_BASELINE.md`, `docs/design/control_center_north_star/SURFACE_COVERAGE.md`, `docs/design/control_center_north_star/RENDER_MANIFEST.md` |
...
| UAA GoatCitadel catch-up prompt pack | `docs/control_center/UAA_GOATCITADEL_CATCHUP_SCOREBOARD.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_AGENT_LOOP_SPINE.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_DURABLE_ORCHESTRATION.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_ACTION_TOOL_CODE_LANES.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_MEMORY_LEARNING.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_EVIDENCE_AUDIT.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_COCKPIT_CLI_API.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_EXTENSIBILITY_FINAL.md`, `docs/prompts/uaa_goatcitadel_catchup/00_execute_uaa_goatcitadel_catchup_end_to_end.prompt.md`, `docs/prompts/uaa_goatcitadel_catchup/README.md`, `docs/prompts/uaa_goatcitadel_catchup/prompt_bundle_manifest.json`, `scripts/dev/run_uaa_goatcitadel_catchup_prompt_pack.sh`, `scripts/dev/uaa_extensions.py`, `scripts/verify_uaa_goatcitadel_catchup_prompt_pack.py`, `scripts/verify_uaa_goatcitadel_catchup_durable_orchestration.py`, `scripts/verify_uaa_goatcitadel_catchup_action_tool_code_lanes.py`, `scripts/verify_uaa_goatcitadel_catchup_memory_learning.py`, `scripts/verify_uaa_goatcitadel_catchup_evidence_audit.py`, `scripts/verify_uaa_goatcitadel_catchup_cockpit_cli_api.py`, `scripts/verify_uaa_goatcitadel_catchup_extensibility_final.py` |
...
| UAA GoatCitadel runtime parity prompt pack | `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_SCORECARD.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ROUTE_DECISION_BINDING.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_STAGED_ORCHESTRATION_ENGINE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_PREPARED_TURN_LOOP.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ROLE_PROVIDER_EVIDENCE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_ACTION_SIGNED_EVIDENCE.md`, `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_FINAL_HARDENING.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/README.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `scripts/verify_uaa_goatcitadel_runtime_parity_scorecard.py`, `scripts/verify_uaa_goatcitadel_runtime_route_decision_binding.py`, `scripts/verify_uaa_goatcitadel_runtime_turn_run_approval_chain.py`, `scripts/verify_uaa_goatcitadel_runtime_staged_orchestration.py`, `scripts/verify_uaa_goatcitadel_runtime_prepared_turn.py`, `scripts/verify_uaa_goatcitadel_runtime_role_provider_evidence.py`, `scripts/verify_uaa_goatcitadel_runtime_action_signed_evidence.py`, `scripts/verify_uaa_goatcitadel_runtime_parity_final.py`, `scripts/verify_uaa_goatcitadel_runtime_parity_prompt_pack.py` |
...
| Operational maturity and authority ramp | `docs/strategy/UAA_AUTHORITY_MODES_AND_MISSION_LEASES.md`, `docs/control_center/OPERATIONALIZATION_LADDER.md`, `docs/control_center/operational_maturity_manifest.json`, `docs/control_center/AUTHORITY_RAMP_CONVEYOR.md`, `docs/control_center/authority_candidate_scorecard.json` |
...
| Plugin/skill ecosystem | `docs/control_center/SKILL_WORKBENCH_DISCOVERY_AND_ADOPTION.md`, `docs/control_center/UAA_GOATCITADEL_CATCHUP_EXTENSIBILITY_FINAL.md`, `docs/tooling/PLUGIN_SKILL_ECOSYSTEM_BOUNDARY.md`, `docs/tooling/INSPECTABLE_EXTENSION_CATALOG.md`, `docs/tooling/EXTENSION_ACTIVATION_GRANTS.md`, `docs/tooling/MCP_A2A_COMPATIBILITY_WATCHLIST.md` |
...
docs/runtime/UAA_GOATCITADEL_RUNTIME_ROUTE_DECISION_BINDING.md
docs/runtime/UAA_GOATCITADEL_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md
