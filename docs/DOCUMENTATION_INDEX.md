...
active M34-M60 sequence. v0.53.0 is the current active baseline after
implementing M49 Mobile Review Approval Capture as exact-scope, review-only,
safe-ref-only mobile approval capture contracts. Active roadmap sources consistently
...
M44, M45, M46, M47, M48, and M49 implemented/released, keep M50-M60 planned/provisional, and rely on documentation-integrity checks to guard
...
skeleton/local connection/review receipt/TestFlight pipeline/build candidate/mobile approval drift.

## Release Notes Index

Current release notes: `docs/release_notes/v0_53_0.md`
