...
| Tool-aware cognition and chat quality queue | `docs/strategy/UAA_TOOL_AWARE_COGNITION_AND_CHAT_QUALITY_PLAN.md`, `docs/roadmap/UAA_TOOL_AWARE_COGNITION_QUEUE_INSERTION.md`, `scripts/verify_tool_aware_cognition_plan.py`, `tests/test_tool_aware_cognition_plan.py` |
