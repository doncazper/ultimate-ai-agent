...
| UAA GoatCitadel runtime parity baseline | `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_SCORECARD.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/README.md`, `scripts/verify_uaa_goatcitadel_runtime_parity_scorecard.py`, `tests/test_uaa_goatcitadel_runtime_parity_scorecard.py` |
...
| UAA GoatCitadel runtime parity prompt pack | `docs/runtime/UAA_GOATCITADEL_RUNTIME_PARITY_SCORECARD.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/README.md`, `docs/prompts/uaa_goatcitadel_runtime_parity/00_execute_runtime_parity_end_to_end.prompt.md`, `scripts/verify_uaa_goatcitadel_runtime_parity_scorecard.py`, `scripts/verify_uaa_goatcitadel_runtime_parity_prompt_pack.py` |
