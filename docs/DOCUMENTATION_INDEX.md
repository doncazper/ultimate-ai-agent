...
| Tool-aware cognition and developer queue | `docs/strategy/UAA_TOOL_AWARE_COGNITION_AND_CHAT_QUALITY_PLAN.md`, `docs/evals/TOOL_AWARE_COGNITION_TAW00_BASELINE.md`, `docs/evals/tool_aware_cognition_taw00_protocol_v1.json`, `docs/roadmap/UAA_TOOL_AWARE_COGNITION_QUEUE_INSERTION.md`, `docs/roadmap/UAA_DEVELOPER_QUEUE_V2_MANIFEST.json`, `docs/roadmap/UAA_REMAINING_QUEUE_MANIFEST.json`, `docs/roadmap/UAA_DEVELOPER_QUEUE_RECOVERY_MANIFEST.json`, `docs/prompts/remaining_queue_recovery/`, `scripts/verify_tool_aware_cognition_plan.py`, `scripts/verify_tool_aware_cognition_taw00.py`, `tests/test_tool_aware_cognition_plan.py`, `tests/test_tool_aware_cognition_taw00.py` (Queue-of-Record V2 is authoritative; TAW-00 is a behavior-preserving fail-closed scaffold with incomplete power, matrix, observation, familywise-bound, holdout-opening, and artifact-census acceptance contracts; external configuration, identity, measurement, and acceptance also remain blocked before routing or prompt change; immutable remaining and recovery manifests are superseded historical evidence) |
