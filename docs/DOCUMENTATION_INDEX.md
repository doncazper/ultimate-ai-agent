...
provider router, no fallback, no autonomous model calls, no background
...
invocation authority from vault presence, and no broad callable runtime
authority.
