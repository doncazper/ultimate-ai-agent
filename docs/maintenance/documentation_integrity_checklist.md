...
Status: Active maintenance checklist, v0.32.1
...
- docs do not claim M29-M40 capabilities are implemented unless a dedicated future milestone implements and gates them.
...
- v0.18.4 post-M20 roadmap projection kept M21-M40 planned/provisional at the time; active docs now mark M28 implemented/released and keep M29-M40 planned/provisional.
...
- At M21 release time, M22-M40 were planned/provisional; current active docs now mark M29 implemented/released and hardened, and keep M30-M40 planned/provisional.
