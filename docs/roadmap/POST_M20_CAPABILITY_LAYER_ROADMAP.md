...
Status: Active roadmap projection maintained through v0.78.0.
...
Recommended next prompt after v0.78.0:

```text
Start v0.79.0 / M75 - Browser Action Dry-Run Planner only after v0.78.0 / M74 is accepted Green.
```
...
implemented/released by v0.78.0 as Browser Observe-Only Adapter. M75-M100 remain
planned/provisional.
