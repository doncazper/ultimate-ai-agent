...
Status: Active roadmap projection maintained through v0.89.0.
...
Recommended next prompt after v0.89.0:

```text
Start v0.90.0 / M86 - Shell Approval Gate v1 only after v0.89.0 / M85 is accepted Green.
```
...
Allowlist. M86-M100 remain planned/provisional.
