...
Status: Active roadmap projection maintained through v0.62.0.
...
M53 is implemented/released. M54 is implemented/released. M55 is implemented/released. M56 is implemented/released. M57 is implemented/released. M58 is implemented/released and M59-M60 remain planned/provisional.
...
The next prompt pack is M53 Controlled Tool Expansion Review.
