...
Status: Active roadmap projection maintained through v0.63.0.
...
M53 is implemented/released. M54 is implemented/released. M55 is implemented/released. M56 is implemented/released. M57 is implemented/released. M58 is implemented/released. M59 is implemented/released as Public GitHub Readiness and M60 remains planned/provisional.
...
The next prompt pack is M60 Local Developer Beta Freeze.
