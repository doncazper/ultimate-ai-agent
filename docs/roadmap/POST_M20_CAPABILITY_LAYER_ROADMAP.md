...
Status: Active roadmap projection maintained through v0.94.0.
...
Recommended next prompt after v0.94.0:

```text
Start v0.95.0 / M91 - Autonomous Tool Execution Contract only after v0.94.0 / M90 is accepted Green.
```
