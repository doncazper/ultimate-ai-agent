...
Status: Active roadmap projection maintained through v0.93.0.
...
Recommended next prompt after v0.93.0:

```text
Start v0.94.0 / M90 - Shell/Subprocess Hardening Freeze only after v0.93.0 / M89 is accepted Green.
```
