...
Status: Active compatibility roadmap projection maintained through v0.45.0. M21-M40 are implemented/released through dedicated reviewed milestones. M34 is implemented/released by v0.38.0 as Broader File Capability Review planning/docs/verifier only. v0.39.0 implements M35 Safe File Review Workflow Contracts as contract-only, review-only logic over already-redacted preview results, v0.39.1 hardens M35 exact file/path binding, v0.40.0 implements M36 CCC File Review Surface, Review-Only as frontend-only, v0.40.1 hardens M36 read-only surface safety, v0.41.0 implements M37 Review Approval Capture, Review-Only Persistence, v0.42.0 implements M38 Safe Context Proposal From Approved Review, v0.43.0 implements M39 CCC Context Proposal Surface, v0.44.0 implements M40 Context Handoff Approval, No Injection, and v0.45.0 implements M41 Local Prototype Safety Freeze. M42-M60 remain planned/provisional.

These charters define capability layers after M20. v0.45.0 is M41 Local Prototype Safety Freeze after v0.44.0 implemented Context Handoff Approval, No Injection. M42-M60 remain future capability layers. Every milestone requires its own implementation prompt, review prompt, hardening expectation, and validation evidence before release.
...
M41 is implemented/released by v0.45.0 as Local Prototype Safety Freeze. M42-M60 are planned/provisional in
