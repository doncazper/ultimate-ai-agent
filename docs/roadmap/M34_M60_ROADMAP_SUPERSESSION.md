...
Status: Active roadmap source of truth through v0.45.0.
...
safety freeze before mobile work resumes.
...
M37 is implemented/released. M38 is implemented/released. M39 is implemented/released. M40 is implemented/released. M41 is implemented/released. M42-M60 remain planned/provisional. M42 resumes mobile planning. M44 is the first iOS
...
Recommended next prompt after v0.45.0:
...
1. M40 Context Handoff Approval, No Injection is implemented/released by v0.44.0.
2. M41 Local Prototype Safety Freeze is implemented/released by v0.45.0.
3. M42 Mobile Companion Product Contract Refresh remains planned/provisional.
