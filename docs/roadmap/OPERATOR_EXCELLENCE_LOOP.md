...
| 9 | Route grouping and side-effect consolidation (`UAA-P1-021`, `UAA-P1-052`) | preserve + surpass | Keeps 99-path API truth understandable as surfaces grow | OpenAPI contract and route manifest checks |
