...
complete for release-surface truth; `FCC-V1-001` is complete for API perimeter
  ...
  productization; and `FCC-V1-007` is the next proof-lane conveyor milestone
  before
