...
complete for release-surface truth; `FCC-V1-001` is complete for API perimeter
  ...
  Today-to-Action receipt loop; and `FCC-V1-004` is the next productization
  conveyor milestone before
