...
complete for release-surface truth; `FCC-V1-001` is complete for API perimeter
  ...
  receipts and reviewable handoffs; and `FCC-V1-005` is the next
  productization conveyor milestone before
