...
- `UAA-P1-087` private operator trial and UI functional tuning: after
  ...
  OpenWebUI shell; `UAA-P1-087.2` uses that boot flow for local/in-person
  founder testing of Today, Actions, Memory,
