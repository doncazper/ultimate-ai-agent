...
- `UAA-P1-087.2` Deferred: later local hands-on UI tuning and manual smoke
  ...
  behind full UAA-P1-087.2. `FCC-V1-000` is the next productization conveyor
  milestone before P2/provider/packaging/commercialization expansion.
