...
| API boundary | FastAPI/OpenAPI boundary with 135 paths, `/api/manifest`, route classification, auth posture, approval posture, idempotency posture, targeted local rate-limit posture, and route inventory checks. |
