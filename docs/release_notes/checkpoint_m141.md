# Checkpoint M141 Release Notes

Checkpoint M141 implements Multi-User Product Boundary while the product
baseline remains v1.7.2.

Included:

- contract-only multi-user product boundary record models for accepted M101-M140 checkpoint refs
- safe user, workspace, tenant, role, privacy, audit, replay, revocation, kill-switch, and no-effect receipt refs
