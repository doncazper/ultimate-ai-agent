...
refs for email scope refs, mailbox boundary refs, consent boundary refs, data
classification refs, retention boundary refs, audit, replay, accepted
checkpoints, and no-effect receipt plans.
