...
- `GET /control-center/today/summary`, `GET /control-center/actions/inbox`,
  ...
  accept/correct create reviewed recall-only records. They do not grant action
  execution, connector writes, CRM/account sync, model/provider calls,
  automatic memory writes, context injection, shell/subprocess work, or
