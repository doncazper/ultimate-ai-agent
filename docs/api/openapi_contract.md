...
v0.19.1 preserves the FastAPI OpenAPI boundary and documents the current route contract without adding public real execution routes.
...
python scripts/export_openapi.py --output docs/api/openapi_v0_19_1.json
```
