...
Current OpenAPI path count: `240`.
...
| `governed-runtime` | 51 | `governed-runtime` | `runtime_pilot_service` | future auth required and exact approval before broader execution | `local_dev_workspace_only`:48, `validation_only`:3 | high | stable/generated from path; unique | partial_backend_not_product_ready |
