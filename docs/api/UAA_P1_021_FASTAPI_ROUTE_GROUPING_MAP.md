...
|---|---|
| OpenAPI path count | 169 paths. |
| `/api/manifest` route count | 169 routes. |
...
| Route inventory doc | Current count matches 169; inventory is summarized by group and remains subordinate to `/api/manifest`. |
