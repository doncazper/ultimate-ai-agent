...
The current OpenAPI path count is `130` after later scoped FCC-V1-003 through
FCC-V1-006 Founder Loop route work and the governed memory L1/L2/L3 index routes.
