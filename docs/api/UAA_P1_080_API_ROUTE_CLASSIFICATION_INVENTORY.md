...
| `local_readonly` | 29 |
| `local_sensitive` | 193 |
| `mutating_requires_authority` | 111 |

The current OpenAPI path count is `336` and `/api/manifest` currently reports
`337` route operations after later scoped FCC-V1-003 through
