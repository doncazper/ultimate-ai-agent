...
| `local_readonly` | 31 |
| `local_sensitive` | 210 |
| `mutating_requires_authority` | 126 |

The current OpenAPI path count is `368` and `/api/manifest` currently reports
`370` route operations after later scoped FCC-V1-003 through
