...
The current OpenAPI path count is `121` after later scoped FCC-V1-003 and
FCC-V1-004 Founder Loop route work. UAA-P1-080 itself added no routes; stable methods,
