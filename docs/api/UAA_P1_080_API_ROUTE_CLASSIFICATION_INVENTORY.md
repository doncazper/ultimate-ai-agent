...
| `local_readonly` | 31 |
| `local_sensitive` | 210 |
| `mutating_requires_authority` | 125 |

The current OpenAPI path count is `367` and `/api/manifest` currently reports
`369` route operations after later scoped FCC-V1-003 through
