...
The current OpenAPI path count is `171` after later scoped FCC-V1-003 through
...
plus the repo-safe Coding Cockpit session read-model seed route and read-only
context-pack preview route.
