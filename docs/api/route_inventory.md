...
live preview, proof, context comparison, patch proposal, budget, redaction, and
authority posture refs only. They do not write files, apply patches, read or
persist raw file content, run shell/subprocess commands, mutate Git state, call
