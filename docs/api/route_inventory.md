...
v0.86.0 M82 Command Proposal Contracts adds no backend route. Command proposal
contracts are core validation objects only. They do not expose
`/commands/execute`, `/shell/execute`, `/process/spawn`, `/filesystem/write`,
`/network/fetch/unrestricted`, `/browser/click`, `/plugins/execute`,
`/remote/execute`, `/memory/write`, `/context/inject`, `/tools/execute`, or any
production authority route. OpenAPI path count remains `75`.
...
v0.88.0 M84 Sandboxed Echo/No-Op Command adds no backend route. Sandboxed
echo/no-op command contracts are core validation objects only. They do not
expose `/sandbox/echo`, `/sandbox/noop`, `/sandbox/commands/run`,
`/sandbox/commands/execute`, `/commands/execute`, `/shell/execute`,
`/process/spawn`, `/filesystem/write`, `/network/fetch/unrestricted`,
`/browser/click`, `/plugins/execute`, `/remote/execute`, `/memory/write`,
`/context/inject`, `/tools/execute`, or any production authority route.
...
- v0.55.0 implements M51 OpenWebUI Bridge Adapter Pilot as deterministic local safe-summary adapter contracts, with no backend route, OpenWebUI route, live OpenWebUI connection route, OpenWebUI runtime call route, raw prompt route, raw provider payload route, provider/model call route, model authority route, tool execution route, memory write route, context injection route, dependency, M52 implementation, or production authority. OpenAPI path count remains `75`.
- v0.56.0 implements M52 OpenWebUI Safe Conversation Surface as deterministic local safe-summary conversation surface contracts, with no backend route, OpenWebUI conversation route, live OpenWebUI connection route, OpenWebUI runtime call route, raw prompt route, raw provider payload route, raw content route, provider/model call route, model authority route, tool execution route, memory write route, context injection route, dependency, M53 implementation, or production authority. OpenAPI path count remains `75`.
- v0.57.0 implements M53 Controlled Tool Expansion Review as deterministic local review-only contracts, with no backend route, tool expansion route, tool register/enable/run/execute route, shell execution route, unrestricted network route, provider/model call route, browser automation route, plugin enablement route, memory write route, context injection route, raw file route, dependency, M54 implementation, or production authority. OpenAPI path count remains `75`.
- v0.58.0 implements M54 Safe Media Metadata Inspector as deterministic local metadata-only contracts, with no backend route, media read/raw/full route, media export route, media transform route, OCIO transform route, AI gamut expansion route, provider/model call route, context injection route, memory write route, tool execution route, dependency, M55 implementation, or production authority. OpenAPI path count remains `75`.
- v0.59.0 implements M55 Redacted Observability Export as deterministic local redacted-only contracts, with no backend route, observability export route, raw prompt/provider payload route, SaaS/analytics export route, network delivery route, provider/model call route, context injection route, memory write route, tool execution route, dependency, M56 implementation, or production authority. OpenAPI path count remains `75`.
- v0.60.0 implements M56 Agent Eval Regression Harness as deterministic local contract-only regression reporting, with no backend route, eval run/execute route, eval raw export route, eval model/provider call route, tool execution route, shell execution route, browser automation route, network access route, context injection route, memory write route, dependency, M57 implementation, or production authority. OpenAPI path count remains `75`.
- v0.61.0 implements M57 Runtime Sandbox Architecture Review as deterministic local architecture-review-only contracts, with no backend route, sandbox run/execute route, subprocess route, process spawn route, shell execution route, file mutation route, network access route, tool execution route, browser automation route, plugin execution route, remote execution route, provider/model call route, context injection route, memory write route, dependency, M58 implementation, or production authority. OpenAPI path count remains `75`.
- v0.62.0 implements M58 Dry-Run Execution Audit Harness as deterministic local dry-run-only contracts, with no backend route, dry-run run/execute route, execution audit run route, subprocess route, process spawn route, shell execution route, file mutation route, network access route, tool execution route, browser automation route, plugin execution route, remote execution route, provider/model call route, context injection route, memory write route, dependency, M59 implementation, or production authority. OpenAPI path count remains `75`.
- v0.63.0 implements M59 Public GitHub Readiness as deterministic local review-only contracts, with no backend route, GitHub publish route, GitHub release route, wiki automation route, public artifact upload route, external service route, credential handling route, network access route, dependency, M60 implementation, post-M60 autonomy, or production authority. OpenAPI path count remains `75`.
- v0.64.0 implements M60 Local Developer Beta Freeze as deterministic local freeze-only contracts, with no backend route, public beta release route, GitHub release route, autonomy route, production enable route, remote execution route, context injection route, memory write route, tool execution route, shell execution route, browser automation route, plugin execution route, credential handling route, dependency, M61 implementation, post-M60 autonomy, public release, external distribution, or production authority. OpenAPI path count remains `75`.
- v0.99.0 implements M95 Network Tool Expansion, Authless Only as exact-scope authless read-only network expansion contracts, with no backend route, network request route, network mutation route, authenticated network route, credential route, cookie route, request body route, account action route, private network route, download/export route, browser form route, provider/model route, shell route, plugin execution route, memory write route, context injection route, dependency, M96 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.0.0 implements M96 Plugin Execution Sandbox, No External Plugins as built-in test plugin sandbox contracts only, with no backend plugin execute route, plugin load route, marketplace route, arbitrary plugin route, network fetch route, shell route, memory write route, context injection route, dependency, M97 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.1.0 implements M97 Recurring Automation Contracts as disabled-by-default contract-only recurring automation metadata, with no backend recurring automation run/start/execute route, scheduler route, cron route, background-worker route, shell route, network route, plugin route, memory write route, context injection route, dependency, M98 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.2.0 implements M98 Scoped Recurring Low-Risk Automation as scoped low-risk read-only recurrence contracts, with no backend recurring automation run/start/execute/collect route, scheduler route, cron route, background-worker route, mutating task route, credential/account route, shell write route, network write route, browser write route, memory write route, context injection route, export route, dependency, M99 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.3.0 implements M99 Autonomy v1 Safety Freeze as freeze-only, review-only M61-M98 autonomy v1 coverage, with no backend autonomy run/execute route, global autonomy route, tool execution route, shell execution route, browser action route, network mutation route, plugin execution route, scheduler route, background-worker route, mobile sensor route, memory write route, context injection route, raw file export route, full-file read route, dependency, M100 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.4.0 implements M100 Mobile Permission Model v1 as contract-only mobile permission taxonomy, consent, revocation, privacy copy, and permission audit contracts, with no backend mobile sensor route, permission request/grant/prompt route, native permission request route, background collection route, push execution route, context injection route, memory write route, dependency, M101 implementation, or production authority. OpenAPI path count remains `75`.
- v1.5.0 implements M101 Mobile Sensor Contract Review as contract-only mobile sensor governance, with no backend mobile sensor route, mobile sensor runtime route, location/camera/photos/microphone route, native permission prompt route, background collection route, raw sensor payload route, context injection route, memory write route, execution route, dependency, M102 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.6.0 implements M102 Location Sensor, Off by Default as contract-only mobile location governance, with no backend location route, location current/history/geofence/export route, location runtime route, native permission prompt route, background location route, raw coordinates route, context injection route, memory write route, execution route, dependency, M103 implementation, broad autonomy, or production authority. OpenAPI path count remains `75`.
- v1.7.0 implements M103 Camera/Photos Metadata-Only Contract as contract-only mobile media governance, with no backend camera route, photo route, media raw/export route, media metadata extraction route, native permission prompt route, background media route, context injection route, memory write route, execution route, dependency, M104 implementation, broad autonomy, mobile sensor runtime, or production authority. OpenAPI path count remains `75`.
