...
Current OpenAPI path count: `219`, generated from the FastAPI application and
exposed through `/api/manifest`. `/api/manifest` currently reports `220` route
...
hardline command blocklist posture, managed scope policy posture,
