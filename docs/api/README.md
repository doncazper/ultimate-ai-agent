...
Current OpenAPI path count: `208`, generated from the FastAPI application and
exposed through `/api/manifest`. `/api/manifest` currently reports `209` route
...
streaming progress, and profile isolation routes,
