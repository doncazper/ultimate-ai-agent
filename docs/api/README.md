...
Current OpenAPI path count: `207`, generated from the FastAPI application and
exposed through `/api/manifest`. `/api/manifest` currently reports `208` route
