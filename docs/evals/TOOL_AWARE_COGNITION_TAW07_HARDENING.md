...
Status: implemented for bounded founder-private development evidence. Independent
promotion and public quality claims remain blocked.
...
expected decision, or per-case result is present. An optional public commitment
and custodian ref may be bound together later, but the private material remains
...
TAW-07 does not complete Q22. TAW-08 must lock the complete candidate manifest,
record founder-private dogfood acceptance with exact measured evidence, reconcile
