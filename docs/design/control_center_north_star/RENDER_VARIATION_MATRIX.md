...
| Founder Loop | `/today` | Today | Daily command deck | information-rich three-column default; title-line weather; non-redundant synthesized briefing; cross-surface attention queue; clearly linked selected-item inspector/drawer; truth-safe queue/complete confirmation; reported-complete review; sourced news with mixed article/email-bulletin sources; compact business pulse and recent receipts; stale or blocked news/weather; CRM follow-up selected; Work Board blocker selected; no decisions; high-risk blocked item; degraded sources; persistent privacy/authority posture; UAA sidecar asking about board/CRM | yes |
