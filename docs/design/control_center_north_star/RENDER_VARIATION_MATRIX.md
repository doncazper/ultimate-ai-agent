...
| Founder Loop | `/today` | Today | Daily command deck | exactly six information-rich panels; title-line weather; non-redundant synthesized briefing; cross-surface attention queue; universal selected-item inspector/drawer; Day Plan with Now/Next; truth-safe queue/complete confirmation; reported-complete review; sourced news with mixed article/email-bulletin sources; Business pulse with embedded recent-activity footer; morning/midday/end-of-day; calm/overloaded; stale or blocked news/weather; CRM follow-up selected; Work Board blocker selected; no decisions; high-risk blocked item; degraded sources; persistent privacy/authority posture; UAA sidecar asking about board/CRM | yes |
