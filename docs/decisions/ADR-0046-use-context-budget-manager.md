# ADR-0046-use-context-budget-manager: Use Context Budget Manager
...
Add explicit context budgeting, context-limit discovery, token calibration, and strategic trimming before long-running agent loops.
