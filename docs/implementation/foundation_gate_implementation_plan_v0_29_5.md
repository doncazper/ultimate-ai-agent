# Foundation Gate Implementation Plan v0.29.5

Status: Active for v0.29.5 documentation organization policy polish.

## Scope

v0.29.5 accepts documentation organization policy wording cleanup only.

## Gate Criteria

- Active version files point to v0.29.5.
- Current release packets live under `docs/archive/releases/v0_29_5/`.
- v0.29.4 archive reference repair checks remain intact.
...
v0.29.5 does not enable skill packages, plugins, runtime tools, package
