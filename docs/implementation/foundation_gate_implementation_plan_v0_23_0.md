# Foundation Gate Implementation Plan v0.23.0

Status: Current Foundation Gate implementation plan for v0.23.0.

v0.23.0 adds the M19 criterion:
...
v0.23.0 does not change the Skill Package Security Rule. It adds no plugin
