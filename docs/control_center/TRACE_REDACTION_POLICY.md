...
v0.20.1 also verifies that selecting alternate trace summaries stays read-only
and that no backend timeline/raw/export route is added in that milestone.
...
No backend route is added in this milestone.
