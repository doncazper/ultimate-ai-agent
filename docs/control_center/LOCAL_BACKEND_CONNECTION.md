...
Status: Active for v0.21.1. Local backend connection behavior is unchanged by M15, v0.19.1 hardening, M16 timeline/trace UI, and M17 evidence/file/memory viewer UI.
