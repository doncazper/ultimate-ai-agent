...
- Settings AuthorityLease state inspection, mode-readiness catalog refs,
  capability mapping refs, and decision-catalog outcome refs through
  `GET /api/runtime/authority-state` without granting or executing authority
