...
export const navItems: NavItem[] = [
  ...
  { path: "/messenger", label: "Messenger", group: "Founder Loop", status: "fixture-only desktop content with backend-owned read-only sync and crypto posture", releaseStatus: "experimental", role: "primary" },
