...
export const navItems: NavItem[] = [
  ...
  { path: "/messenger", label: "Messenger", group: "Founder Loop", status: "fixture-only desktop content with backend-owned sync, crypto, and exact manual-messaging posture; synthetic composer remains disabled", releaseStatus: "experimental", role: "primary" },
