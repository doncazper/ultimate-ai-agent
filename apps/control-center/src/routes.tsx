...
export const navItems: NavItem[] = [
  ...
  { path: "/messenger", label: "Messenger", group: "Founder Loop", status: "fixture-only desktop content with backend-owned sync, crypto, exact manual-messaging, and rooms/search/media posture; synthetic controls remain disabled", releaseStatus: "experimental", role: "primary" },
