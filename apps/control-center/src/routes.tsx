...
export const navItems: NavItem[] = [
  ...
  { path: "/messenger", label: "Messenger", group: "Founder Loop", status: "fixture-only desktop content with backend-owned sync, crypto, messaging, rooms/media, and partial intelligence posture; synthetic controls remain disabled", releaseStatus: "experimental", role: "primary" },
