...
export function DecisionReviewSurface({ data }: { data: ControlCenterData }) {
  ...
  const canCommitLocalTask = Boolean(
    ...
    && localTaskAuthorityPreview.status === "ready",
  );
