...
export const workspaceNavItems: WorkspaceNavItem[] = [
  ...
  { id: "communications", label: "Communications", icon: "mail", href: `${WORKSPACE_PREFIX}/communications`, section: "primary" },
  { id: "messenger", label: "Messenger", icon: "messages-square", href: "/messenger", section: "primary" },
...
export function workspaceSurfaceFromPath(path: string): WorkspaceSurfaceId | undefined {
