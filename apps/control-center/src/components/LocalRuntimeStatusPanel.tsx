...
const LOCAL_RUNTIME_BOUNDARY_COPY =
  "Local runtime status is backend-owned. Exact approved utility command execution is visible through RuntimeGateway receipts; this UI does not start runtimes or grant arbitrary command, browser, connector, plugin, remote, public beta, or production authority.";
