...
const runtimeStagedOrchestration: RuntimeStagedOrchestrationReadModel = {
  schema_version: "staged_orchestration_engine.v1",
  contract_ref: "contract-ref:staged-orchestration-engine:v1",
  source: "python_core_staged_orchestration_read_model",
  backend_owned: true,
  plan: {
    schema_version: "staged_orchestration_engine.v1",
    ...
    safe_summary:
      "Mock staged orchestration fallback keeps waiting, degraded, and skipped steps visible without execution.",
    status: "waiting",
    stages: [
      {
        ...
        degraded_handoff_refs: [],
      },
      {
        stage_ref: "stage-ref:staged-orchestration:approval",
        sequence: 2,
        safe_summary: "Wait for exact approval posture before future execution.",
        status: "waiting",
        step_refs: [
        ...
        degraded_handoff_refs: [
          "handoff-ref:staged-orchestration:operator-review",
        ],
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        approval_posture_ref:
          "approval-posture-ref:staged-orchestration:operator-wait",
      ...
      },
      {
        ...
        stage_ref: "stage-ref:staged-orchestration:approval",
        safe_summary: "Create degraded operator handoff when scope is incomplete.",
        status: "degraded",
        mode: "validation_only",
        depends_on_step_refs: ["step-ref:staged-orchestration:context-pack"],
        policy_ref: "policy-ref:staged-orchestration:degraded-handoff",
        approval_posture_ref:
          "approval-posture-ref:staged-orchestration:operator-review",
        checkpoint_ref: "checkpoint-ref:staged-orchestration:approval",
      ...
      },
      {
        ...
        stage_ref: "stage-ref:staged-orchestration:recovery",
        safe_summary: "Skip downstream recovery until approval is complete.",
        status: "skipped",
        mode: "background_worker_blocked",
        depends_on_step_refs: ["step-ref:staged-orchestration:approval-wait"],
        policy_ref: null,
        approval_posture_ref: null,
        checkpoint_ref: null,
        evidence_refs: [],
        receipt_refs: [],
        blocked_authority_refs: [
    ...
    degraded_handoffs: [
      {
        ...
        safe_summary: "Operator review required before future execution.",
        reason_refs: ["reason-ref:staged-orchestration:approval-scope-incomplete"],
        checkpoint_ref: "checkpoint-ref:staged-orchestration:approval",
        evidence_refs: ["evidence-ref:staged-orchestration:degraded-review"],
        receipt_refs: ["receipt-ref:staged-orchestration:degraded-review"],
    ...
    no_effect: true,
    approved_runtime_command_execution_enabled: false,
    background_autonomy_enabled: false,
    provider_model_call_enabled: false,
    unrestricted_command_execution_enabled: false,
  },
  validation: {
    schema_version: "staged_orchestration_engine.v1",
    plan_ref: "plan-ref:staged-orchestration:sample",
    status: "accepted",
    reason_codes: [],
    safe_summary: "Staged orchestration plan validated as a no-effect read model.",
    blocked_authority_refs: [
      "blocked-state:staged-orchestration:no-autonomous-worker",
      "blocked-state:staged-orchestration:no-hidden-model-call",
      "blocked-state:staged-orchestration:no-unrestricted-command-execution",
  ...
  latest_checkpoint_ref: "checkpoint-ref:staged-orchestration:approval",
  cli_ref: "repo-local-command:uaa-runtime-inspect-staged-orchestration",
  api_ref: "GET /api/runtime/staged-orchestration",
  authority_state_route_ref: "GET /api/runtime/authority-state",
  authority_state_cli_ref:
    "repo-local-command:uaa-runtime-inspect-authority-state",
  authority_state_mapping_ref: "lane-ref:staged-orchestration-read-model",
  authority_state_catalog_ref:
    "authority-decision-catalog-ref:staged-orchestration-read-model",
  authority_state_decision_ref:
    "authority-policy-decision-ref:mock-staged-orchestration-read",
  authority_state_decision_outcome: "allow",
  authority_state_status: "implemented_authority_bound_read_model",
  authority_state_operator_message: "Allowed by active authority lease.",
  authority_state_reason_refs: [
  ...
  runtime_command_authority_state_catalog_ref:
    "authority-decision-catalog-ref:staged-orchestration-approved-runtime-command",
  runtime_command_authority_state_decision_ref:
    "authority-policy-decision-ref:mock-staged-orchestration-runtime-command",
  runtime_command_authority_state_decision_outcome: "degrade_to_draft",
  ...
  execution_performed: false,
  approved_runtime_command_execution_enabled: false,
  runtime_execution_performed_by_read_model: false,
  control_center_can_mint_authority: false,
};
...
const trustAuthorityMatrix: TrustAuthorityMatrix = {
  ...
  lanes: [
    ...
    {
      lane_ref: "trust-lane:mock-external-mutation-planned",
      label: "External mutation planned unsupported",
      tier: 4,
      tier_id: "tier_4_external_mutation",
      tier_label: "External mutation",
      lane_kind: "external_mutation",
      authority_state: "planned",
      authority_state_label: "planned unsupported",
      operator_posture: "planned",
      ...
      current_posture:
        "External sends, writes, provider calls, browser, and shell work are known authority domains, but this mock fallback has no executable adapters.",
      approval_posture:
        "Future Tier 4 lanes require exact adapter support, approval, idempotency, receipts, safe-disable, and rollback posture.",
      operator_can_do_now: "Use local read and preview lanes only; inspect planned unsupported refs through Python Core.",
      next_safe_action: "Do not infer external authority from mock fallback.",
      route_refs: [],
      proof_refs: ["proof-ref:mock-fallback:external-mutation-planned"],
      verifier_refs: ["tests/test_trust_authority_matrix.py"],
      docs_refs: ["docs/strategy/UAA_AUTHORITY_MODES_AND_MISSION_LEASES.md"],
      cli_inspection_refs: [
        "python scripts/dev/uaa_founder_loop.py inspect-trust-authority",
      ...
      safe_disable_refs: [
        "safe-disable-ref:trust:mock-external-mutation:planned-unsupported",
      ],
      rollback_refs: [
  ...
  tier_summaries: [
    ...
    },
    {
      ...
      blocked_count: 0,
      operator_summary:
        "Mock external mutation posture is planned unsupported and non-executing.",
    },
  ],
  authority_domain_coverage: [
    {
      domain_ref: "authority-domain-ref:workspace",
      label: "workspace",
      status: "implemented",
      known_authority: true,
      mapping_count: 2,
      implemented_mapping_count: 2,
      partial_mapping_count: 0,
      planned_mapping_count: 0,
      hidden_mapping_ref_count: 0,
      visible_mapping_refs: [
        "lane-ref:mock-local-read-preview",
        "lane-ref:mock-local-draft",
      ],
      unsupported_adapter_refs: [],
      authority_state_route_ref: "GET /api/runtime/authority-state",
      authority_state_cli_ref:
        "repo-local-command:uaa-runtime-inspect-authority-state",
      operator_summary:
        "Mock workspace coverage is fallback shape only; backend Trust is required before relying on authority.",
      active_lease_required: true,
      safe_refs_only: true,
      execution_claimed: false,
    },
    {
      domain_ref: "authority-domain-ref:shell",
      label: "shell",
      status: "planned",
      known_authority: true,
      mapping_count: 1,
      implemented_mapping_count: 0,
      partial_mapping_count: 0,
      planned_mapping_count: 1,
      hidden_mapping_ref_count: 0,
      visible_mapping_refs: ["lane-ref:shell-arbitrary-command-adapter"],
      unsupported_adapter_refs: [
      ...
      authority_state_cli_ref:
        "repo-local-command:uaa-runtime-inspect-authority-state",
      operator_summary:
        "Mock shell coverage stays planned; arbitrary command execution is not available from fallback data.",
      active_lease_required: true,
      safe_refs_only: true,
      execution_claimed: false,
    },
  ...
  authority_capability_catalog: trustAuthorityCapabilityCatalog([
    ...
    },
    {
      ...
      approval_posture:
        "Future Tier 4 lanes require exact adapter support, approval, idempotency, receipts, safe-disable, and rollback posture.",
      operator_can_do_now:
        "Use local read and preview lanes only; inspect planned unsupported refs through Python Core.",
      next_safe_action: "Do not infer external authority from mock fallback.",
      route_refs: [],
      proof_refs: ["proof-ref:mock-fallback:external-mutation-planned"],
      verifier_refs: ["tests/test_trust_authority_matrix.py"],
  ...
  authority_capability_catalog_refs: [
    ...
    "authority-capability-catalog-ref:mock-external-mutation-planned:apps:write",
  ],
  available_now_lane_refs: ["trust-lane:mock-local-read-preview"],
  approval_required_lane_refs: [],
  planned_lane_refs: ["trust-lane:mock-external-mutation-planned"],
  blocked_lane_refs: [],
  route_refs: ["GET /control-center/trust-authority/matrix"],
  proof_refs: [
    "proof-ref:mock-fallback:trust-authority",
    "proof-ref:mock-fallback:external-mutation-planned",
  ],
  verifier_refs: ["tests/test_trust_authority_matrix.py"],
  docs_refs: ["docs/strategy/UAA_AUTHORITY_MODES_AND_MISSION_LEASES.md"],
  cli_inspection_refs: [
...
export const mockControlCenterData: ControlCenterData = {
  ...
  settingsStatus: {
    ...
    authority_lease_state: {
      ...
      mode_catalog: [
        {
          ...
          mode: "read_only",
          scope: "session",
          status: "issue_ready_no_approval_required",
          default_requested_domains: {
          ...
          granted_default_domains: {
            workspace: ["observe", "read", "draft", "prepare"],
            memory: ["observe", "read", "draft"],
          },
          denied_default_domain_refs: [],
          unsupported_adapter_refs: [],
          blocked_reason_refs: [],
          approval_required: false,
          issue_ready: true,
          requires_mission_ref: false,
          safe_refs_only: true,
          execution_performed: false,
          mutation_performed: false,
          operator_summary:
            "Read-only default scope is issue-ready for mock inspection only.",
        },
        {
          schema_version: "uaa-authority-mode-catalog-entry.v1",
          mode: "ask_before_changes",
          scope: "session",
          status: "issue_ready_approval_required",
          default_requested_domains: {
          ...
          mutation_performed: false,
          operator_summary:
            "Ask-before-changes requires an explicit operator approval receipt.",
        },
        {
          schema_version: "uaa-authority-mode-catalog-entry.v1",
          ...
          mutation_performed: false,
          operator_summary:
            "Safe local work can issue for exact workspace capabilities after approval.",
        },
        {
          schema_version: "uaa-authority-mode-catalog-entry.v1",
          ...
          mutation_performed: false,
          operator_summary:
            "Full local workspace can issue for local workspace, files, and memory after approval.",
        },
        {
          schema_version: "uaa-authority-mode-catalog-entry.v1",
          mode: "full_machine_access_session",
          scope: "session",
          status: "blocked_default_scope_unsupported",
          default_requested_domains: {
            shell: ["execute"],
            apps: ["observe", "click"],
            browser: ["observe", "click", "form_fill", "upload", "download"],
            system_settings: ["read", "mutate"],
          },
          grantable_domains: {
            workspace: ["read", "write", "execute", "commit"],
            files: ["read", "write", "mutate"],
          ...
          granted_default_domains: {},
          denied_default_domain_refs: [
            "authority-domain-ref:shell",
            "authority-domain-ref:apps",
            "authority-domain-ref:browser",
          ],
          unsupported_adapter_refs: [
            "adapter-ref:shell:execute-not-implemented-for-authority-lease-v1",
            "adapter-ref:apps:click-not-implemented-for-authority-lease-v1",
            "adapter-ref:browser:click-not-implemented-for-authority-lease-v1",
          ],
          blocked_reason_refs: [
            "reason-ref:authority:mode-default-scope-denied",
            "reason-ref:authority:adapter-unsupported",
          ],
          approval_required: true,
          issue_ready: false,
          ...
          mutation_performed: false,
          operator_summary:
            "Full machine default scope is blocked because shell, app, browser, and settings adapters are unsupported.",
        },
        {
          schema_version: "uaa-authority-mode-catalog-entry.v1",
          ...
          blocked_reason_refs: [
            "reason-ref:authority:mode-default-scope-denied",
            "reason-ref:authority:adapter-unsupported",
            "reason-ref:authority:mission-scope-required",
          ],
          approval_required: true,
          issue_ready: false,
          requires_mission_ref: true,
          safe_refs_only: true,
          execution_performed: false,
          mutation_performed: false,
          operator_summary:
            "Delegated mission default scope is blocked until mission scope plus browser/payment adapters are implemented and approved.",
        },
      ],
      active_leases: [
        {
      ...
      capability_mappings: [
        {
          ...
          unsupported_adapter_refs: [],
          unsupported_adapter_blocks_capability: false,
          operator_copy:
      ...
      decision_summary: {
        ...
        ask_capability_refs: [],
        degraded_capability_refs: ["authority-capability-ref:mock-file-preview"],
        ...
        operator_summary:
          "Mock authority summary covers three fallback capabilities for layout only: allowed read, lease-required file preview, and denied unsupported browser action.",
        safe_refs_only: true,
        execution_performed: false,
        mutation_performed: false,
        control_center_grants_authority: false,
      ...
      decision_catalog: [
        {
          ...
          route_refs: ["GET /api/runtime/authority-state"],
          cli_refs: ["repo-local-command:uaa-runtime-inspect-authority-state"],
          evidence_refs: ["evidence-ref:authority-catalog:mock-workspace-read"],
          unsupported_adapter_refs: [],
          decision: {
            schema_version: "uaa-authority-state.v1",
            decision_ref: "authority-policy-decision-ref:mock-catalog-read",
            action_ref: "authority-action-ref:catalog:mock-workspace-read",
            outcome: "allow",
            domain: "workspace",
            capability: "read",
            lease_ref: "authority-lease-ref:mock-read-only-session",
            ...
            required_capability_refs: ["authority-capability-ref:read"],
            reason_refs: [
              "reason-ref:authority:active-lease-grants-domain-capability",
            ],
            ...
            audit_required: true,
            redaction_required: true,
            rollback_ref: "rollback-ref:authority-policy:mock-catalog-read",
            safe_disable_ref:
              "safe-disable-ref:authority-policy:mock-catalog-read",
            kill_switch_ref: "kill-switch-ref:authority-lease-local",
            receipt_ref: "receipt-ref:authority-policy:mock-catalog-read",
            audit_record_ref: "audit-ref:authority-policy:mock-catalog-read",
            redactions_applied: ["safe_refs_only", "credentials_omitted"],
            decided_at: "2026-07-06T00:00:00Z",
          },
          operator_summary:
            "Mock workspace read currently evaluates to allow under fallback AuthorityLease shape.",
          safe_refs_only: true,
          execution_performed: false,
          mutation_performed: false,
          control_center_grants_authority: false,
        ...
        {
          catalog_ref: "authority-decision-catalog-ref:mock-file-preview",
          authority_capability_ref: "authority-capability-ref:mock-file-preview",
          lane_ref: "lane-ref:file-safe-preview",
          label: "Mock file safe preview",
          status: "implemented_exact_lease_required_metadata_only",
          route_refs: ["POST /files/read/preview", "POST /files/tree/preview"],
          cli_refs: ["repo-local-command:uaa-runtime-inspect-authority-state"],
          evidence_refs: ["evidence-ref:authority-catalog:mock-file-preview"],
          unsupported_adapter_refs: [
            "adapter-ref:file-raw-content:not-implemented",
          ],
          decision: {
            schema_version: "uaa-authority-state.v1",
            decision_ref: "authority-policy-decision-ref:mock-catalog-file",
            action_ref: "authority-action-ref:catalog:mock-file-preview",
            ...
            matched_mode: null,
            required_mode: "read_only",
            required_domain_refs: ["authority-domain-ref:files"],
            required_capability_refs: ["authority-capability-ref:read"],
            reason_refs: [
              "reason-ref:authority:no-active-lease-for-domain-capability",
            ],
            ...
            audit_required: true,
            redaction_required: true,
            rollback_ref: "rollback-ref:authority-policy:mock-catalog-file",
            safe_disable_ref:
              "safe-disable-ref:authority-policy:mock-catalog-file",
            kill_switch_ref: "kill-switch-ref:authority-lease-local",
            receipt_ref: null,
            audit_record_ref: "audit-ref:authority-policy:mock-catalog-file",
            redactions_applied: ["safe_refs_only", "credentials_omitted"],
            decided_at: "2026-07-06T00:00:00Z",
          },
          operator_summary:
        ...
        },
        {
          ...
          route_refs: ["GET /api/runtime/authority-state"],
          cli_refs: ["repo-local-command:uaa-runtime-inspect-authority-state"],
          evidence_refs: ["evidence-ref:authority-catalog:mock-browser-click"],
          unsupported_adapter_refs: [
            "adapter-ref:browser-execution:not-implemented",
          ],
          decision: {
            schema_version: "uaa-authority-state.v1",
            decision_ref: "authority-policy-decision-ref:mock-catalog-browser",
            action_ref: "authority-action-ref:catalog:mock-browser-click",
            outcome: "deny",
            domain: "browser",
            capability: "click",
            lease_ref: null,
            ...
            required_capability_refs: ["authority-capability-ref:click"],
            ...
            audit_required: true,
            redaction_required: true,
            rollback_ref: "rollback-ref:authority-policy:mock-catalog-browser",
            safe_disable_ref:
              "safe-disable-ref:authority-policy:mock-catalog-browser",
            kill_switch_ref: "kill-switch-ref:authority-lease-local",
            receipt_ref: null,
            audit_record_ref: "audit-ref:authority-policy:mock-catalog-browser",
            redactions_applied: ["safe_refs_only", "credentials_omitted"],
            decided_at: "2026-07-06T00:00:00Z",
          },
          operator_summary:
            "Mock browser click currently evaluates to deny because the adapter is not implemented.",
          safe_refs_only: true,
          execution_performed: false,
          mutation_performed: false,
          control_center_grants_authority: false,
  ...
  runtimeStagedOrchestration: runtimeStagedOrchestration,
  ...
  runtimeInterruptRedirect: {
    ...
    authority_state_catalog_ref:
      "authority-decision-catalog-ref:runtime-interrupt-redirect-proposals",
    authority_state_decision_ref:
  ...
  runtimeResultClassification: {
    ...
    authority_state_catalog_ref:
      "authority-decision-catalog-ref:runtime-result-classification-taxonomy",
    authority_state_decision_ref:
