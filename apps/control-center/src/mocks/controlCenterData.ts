...
export const mockControlCenterData: ControlCenterData = {
  ...
  runtimeInterfaceMode: {
    ...
    status: "mock_fallback_interface_mode",
    active_mode: "shell_guarded",
    mode_profiles: [
      {
        mode: "shell_guarded",
    ...
    hermes_cli_posture: {
      ...
      safe_summary:
        "Mock fallback: Hermes CLI readiness is unavailable until Python Core returns the interface-mode read model.",
    ...
    credential_material_persisted: false,
    safe_summary:
      "Mock fallback: Runtime interface mode will let Control Center supervise Hermes while UAA-native agent execution stays off.",
    blocked_authority_refs: [
      "blocked-authority:hermes-unrestricted-command-execution",
  ...
  runtimeHermesContextPack: {
    ...
    status: "mock_fallback_curated_context",
    built_at_ref: "time-ref:mock-fallback",
    source_count: 9,
    section_count: 9,
    sections: [
      ["memory", "Memory Review and reviewed context"],
      ["crm", "CRM local command center"],
      ["chat", "Chat turns and handoffs"],
      ["cowork-plans", "Cowork and Plans"],
      ["today", "Today"],
      ...
      section_ref: `hermes-context-section-ref:${key}`,
      source_surface: label,
      projected_to_hermes: true,
      uaa_native_source_ref: `source-ref:${key}`,
      safe_summary:
        "Mock fallback: this Hermes context section exposes redacted summaries and safe refs only.",
      provenance_refs: [`source-ref:${key}`],
      why_shown_refs: [
        `why-shown-ref:hermes-context:${key}:current-operator-loop`,
      ],
      evidence_refs: [`evidence-ref:hermes-context:${key}`],
      proof_refs: [`proof-ref:hermes-context:${key}:redacted`],
      route_refs: ["GET /api/runtime/hermes/context-pack"],
    })),
    token_budget_ref: "context-budget-ref:hermes-interface-mode-bounded",
    safe_summary:
      "Mock fallback: Hermes receives curated UAA summaries, provenance refs, why-shown refs, evidence refs, and proof refs only.",
    memory_update_policy: "candidate_only_review_required",
    ...
    projected_provenance_visible: true,
