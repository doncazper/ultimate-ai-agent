  ...
  dashboard: {
    ...
    provider_credential_readiness: {
      ...
      vault_adapter_readiness: {
        ...
        readiness_status: "blocked_contract_only",
        blocker_codes: [
          "VAULT_ADAPTER_NOT_SCOPED",
      ...
      validation_readiness: {
        ...
        safe_summary:
          "Provider key validation is not scoped; any future validation must use safe refs, explicit consent, policy, approval, revocation, and redacted receipts.",
      },
