export const API_ENDPOINTS = {
  ...
  controlCenterBackendTruth: "/control-center/backend-truth",
  ...
  communicationsMatrixIntelligencePosture:
  ...
  newsSignalsSummary: "/control-center/news-signals/summary",
  newsSignalsAdoption: "/control-center/news-signals/adoption",
  newsSignalsAdoptionPreview: "/control-center/news-signals/adoption/preview",
  newsSignalsAdoptionApproval: "/control-center/news-signals/adoption/approval",
  newsSignalsAdoptionCommit: "/control-center/news-signals/adoption/commit",
  ...
  crmAdoption: "/control-center/crm/adoption",
  crmAdoptionQuery: "/control-center/crm/adoption/query",
  crmAdoptionPreview: "/control-center/crm/adoption/preview",
  crmAdoptionApproval: "/control-center/crm/adoption/approval",
  crmAdoptionCommit: "/control-center/crm/adoption/commit",
  crmAdoptionBackup: "/control-center/crm/adoption/backup",
  crmAdoptionRestorePreview: "/control-center/crm/adoption/restore-preview",
  crmAdoptionRestore: "/control-center/crm/adoption/restore",
...
export const READ_ENDPOINTS = [
  ...
  API_ENDPOINTS.newsSignalsSummary,
  API_ENDPOINTS.newsSignalsAdoption,
