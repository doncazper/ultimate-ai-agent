export const API_ENDPOINTS = {
  ...
  founderMemoryImpactGraph: "/control-center/memory/impact-graph",
  founderMemoryFollowUps: "/control-center/memory/follow-ups",
  founderMemoryRecallHealth: "/control-center/memory/recall-health",
