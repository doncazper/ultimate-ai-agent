...
export interface ActionToolLanePostureRow {
  capability_id: string;
  capability_ref: string;
  lane_ref: string;
  label: string;
...
export interface ActionToolLanePosture {
  schema_version: string;
  contract_ref: string;
  catalog_contract_ref: string;
  catalog_ref: string;
  status: string;
  source: string;
  route_ref: string;
...
export interface RuntimeWorktreePerAgentReadModel {
  ...
  authority_state_route_ref: string;
  authority_state_cli_ref: string;
  authority_state_decision_count: number;
  authority_state_allowed_count: number;
  authority_state_degraded_count: number;
  authority_state_denied_count: number;
  authority_state_mapping_refs: string[];
  authority_state_decision_refs: string[];
