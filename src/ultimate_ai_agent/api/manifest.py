...
CAPABILITIES_DECLARED = [
    ...
    "control_center_news_signals_backend_read_model",
    "control_center_news_signals_today_briefing_projections",
    ...
    "communications_reviewed_local_projection_read_model",
...
CONTROL_CENTER_COMMUNICATIONS_READONLY_PATHS = {
    ...
    "/control-center/communications/conversations",
    "/control-center/communications/conversations/{conversation_ref}",
...
def route_classification_for_path(
    ...
    if normalized_method == "POST" and path == "/api/runtime/goals":
        return (
            ApiRouteClassification.mutating_requires_authority,
