...
class FoundationGateLegacyChecksPart022Mixin:
    ...
    def check_m87_sandboxed_command_audit_replay_route_boundary(
        ...
        try:
            ...
            failures.extend(m87_openapi_route_failures(self._openapi_paths()))
    ...
    def check_m88_mutating_command_proposal_route_boundary(
        ...
        try:
            ...
            failures.extend(m88_openapi_route_failures(self._openapi_paths()))
        except Exception as exc:
    ...
    def check_m89_emergency_stop_process_kill_route_boundary(
        ...
        try:
            ...
            failures.extend(m89_openapi_route_failures(self._openapi_paths()))
        except Exception as exc:
    ...
    def check_m90_shell_subprocess_route_boundary(
        ...
        try:
            ...
            failures.extend(m90_openapi_route_failures(self._openapi_paths()))
        except Exception as exc:
