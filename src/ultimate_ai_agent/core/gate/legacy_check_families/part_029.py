...
class FoundationGateLegacyChecksPart029Mixin:
    ...
    def check_m113_secrets_boundary_route_boundary(
        ...
        try:
            ...
            failures.extend(m113_openapi_route_failures(self._openapi_paths()))
        except Exception as exc:
    ...
    def check_m114_account_connector_route_boundary(
        ...
        try:
            ...
            failures.extend(m114_openapi_route_failures(self._openapi_paths()))
        except Exception as exc:
    ...
    def check_m115_production_audit_retention_route_boundary(
        ...
        try:
            ...
            failures.extend(m115_openapi_route_failures(self._openapi_paths()))
        except Exception as exc:
