...
|---|---|---|
| API boundary | Implemented for the current **227** OpenAPI paths, **228** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **227** OpenAPI paths and **228** manifest route operations |
