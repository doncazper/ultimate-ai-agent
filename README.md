...
|---|---|---|
| API boundary | Implemented for the current **198** OpenAPI paths, **199** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **198** OpenAPI paths and **199** manifest route operations |
