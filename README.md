...
|---|---|---|
| API boundary | Implemented for the current **189** OpenAPI paths, **190** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **189** OpenAPI paths and **190** manifest route operations |
