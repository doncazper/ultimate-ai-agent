...
|---|---|---|
| API boundary | Implemented for the current **231** OpenAPI paths, **232** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **231** OpenAPI paths and **232** manifest route operations |
