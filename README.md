...
|---|---|---|
| API boundary | Implemented for the current **173** OpenAPI paths and `/api/manifest` metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **173** OpenAPI paths |
