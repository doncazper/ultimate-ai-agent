...
|---|---|---|
| API boundary | Implemented for the current **185** OpenAPI paths, **186** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **185** OpenAPI paths and **186** manifest route operations |
