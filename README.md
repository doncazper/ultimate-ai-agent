...
|---|---|---|
| API boundary | Implemented for the current **215** OpenAPI paths, **216** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **215** OpenAPI paths and **216** manifest route operations |
