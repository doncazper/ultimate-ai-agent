...
|---|---|---|
| API boundary | Implemented for the current **197** OpenAPI paths, **198** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **197** OpenAPI paths and **198** manifest route operations |
