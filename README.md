...
| API boundary | FastAPI route contract with **128** OpenAPI paths |
...
| API contract | **128** OpenAPI paths, stable operation IDs, route metadata | [API boundary](docs/api/README.md), [route inventory](docs/api/route_inventory.md) |
