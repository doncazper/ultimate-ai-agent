...
|---|---|---|
| API boundary | Implemented for the current **245** OpenAPI paths, **246** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **245** OpenAPI paths and **246** manifest route operations |
