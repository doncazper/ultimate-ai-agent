...
|---|---|---|
| API boundary | Implemented for the current **234** OpenAPI paths, **235** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **234** OpenAPI paths and **235** manifest route operations |
