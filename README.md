...
|---|---|---|
| API boundary | Implemented for the current **246** OpenAPI paths, **247** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **246** OpenAPI paths and **247** manifest route operations |
