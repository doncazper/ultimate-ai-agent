...
|---|---|---|
| API boundary | Implemented for the current **216** OpenAPI paths, **217** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **216** OpenAPI paths and **217** manifest route operations |
