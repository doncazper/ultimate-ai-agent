...
|---|---|---|
| API boundary | Implemented for the current **253** OpenAPI paths, **254** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **253** OpenAPI paths and **254** manifest route operations |
