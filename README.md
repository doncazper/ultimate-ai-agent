...
|---|---|---|
| API boundary | Implemented for the current **188** OpenAPI paths, **189** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **188** OpenAPI paths and **189** manifest route operations |
