...
|---|---|---|
| API boundary | Implemented for the current **250** OpenAPI paths, **251** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **250** OpenAPI paths and **251** manifest route operations |
