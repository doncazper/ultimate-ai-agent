...
|---|---|---|
| API boundary | Implemented for the current **235** OpenAPI paths, **236** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **235** OpenAPI paths and **236** manifest route operations |
