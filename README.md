...
|---|---|---|
| API boundary | Implemented for the current **236** OpenAPI paths, **237** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **236** OpenAPI paths and **237** manifest route operations |
