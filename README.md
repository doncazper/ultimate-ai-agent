...
|---|---|---|
| API boundary | Implemented for the current **211** OpenAPI paths, **212** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **211** OpenAPI paths and **212** manifest route operations |
