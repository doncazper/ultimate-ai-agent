...
|---|---|---|
| API boundary | Implemented for the current **201** OpenAPI paths, **202** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **201** OpenAPI paths and **202** manifest route operations |
