...
|---|---|---|
| API boundary | Implemented for the current **184** OpenAPI paths, **185** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **184** OpenAPI paths and **185** manifest route operations |
