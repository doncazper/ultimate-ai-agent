...
|---|---|---|
| API boundary | Implemented for the current **220** OpenAPI paths, **221** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **220** OpenAPI paths and **221** manifest route operations |
