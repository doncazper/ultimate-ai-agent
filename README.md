...
|---|---|---|
| API boundary | Implemented for the current **170** OpenAPI paths and `/api/manifest` metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **170** OpenAPI paths |
