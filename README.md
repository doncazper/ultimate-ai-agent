...
|---|---|---|
| API boundary | Implemented for the current **218** OpenAPI paths, **219** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **218** OpenAPI paths and **219** manifest route operations |
