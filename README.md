...
|---|---|---|
| API boundary | Implemented for the current **204** OpenAPI paths, **205** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **204** OpenAPI paths and **205** manifest route operations |
