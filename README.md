...
|---|---|---|
| API boundary | Implemented for the current **205** OpenAPI paths, **206** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **205** OpenAPI paths and **206** manifest route operations |
