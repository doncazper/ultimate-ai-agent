...
|---|---|---|
| API boundary | Implemented for the current 136-path FastAPI/OpenAPI boundary and `/api/manifest` metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **136** OpenAPI paths |
