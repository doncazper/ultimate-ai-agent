...
|---|---|---|
| API boundary | Implemented for the current **230** OpenAPI paths, **231** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **230** OpenAPI paths and **231** manifest route operations |
