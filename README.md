...
|---|---|---|
| API boundary | Implemented for the current **223** OpenAPI paths, **224** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **223** OpenAPI paths and **224** manifest route operations |
