...
|---|---|---|
| API boundary | Implemented for the current **225** OpenAPI paths, **226** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **225** OpenAPI paths and **226** manifest route operations |
