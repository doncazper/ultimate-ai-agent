...
|---|---|---|
| API boundary | Implemented for the current **212** OpenAPI paths, **213** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **212** OpenAPI paths and **213** manifest route operations |
