...
|---|---|---|
| API boundary | Implemented for the current **203** OpenAPI paths, **204** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **203** OpenAPI paths and **204** manifest route operations |
