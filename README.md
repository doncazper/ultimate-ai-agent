...
|---|---|---|
| API boundary | Implemented for the current **226** OpenAPI paths, **227** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **226** OpenAPI paths and **227** manifest route operations |
