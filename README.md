...
|---|---|---|
| API boundary | Implemented for the current **196** OpenAPI paths, **197** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **196** OpenAPI paths and **197** manifest route operations |
