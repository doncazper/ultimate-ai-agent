...
|---|---|---|
| API boundary | Implemented for the current **239** OpenAPI paths, **240** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **239** OpenAPI paths and **240** manifest route operations |
