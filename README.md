...
|---|---|---|
| API boundary | Implemented for the current **263** OpenAPI paths, **264** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **263** OpenAPI paths and **264** manifest route operations |
