...
|---|---|---|
| API boundary | Implemented for the current **210** OpenAPI paths, **211** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **210** OpenAPI paths and **211** manifest route operations |
