...
|---|---|---|
| API boundary | Implemented for the current **257** OpenAPI paths, **258** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **257** OpenAPI paths and **258** manifest route operations |
