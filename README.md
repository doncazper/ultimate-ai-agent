...
|---|---|---|
| API boundary | Implemented for the current **219** OpenAPI paths, **220** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **219** OpenAPI paths and **220** manifest route operations |
