...
|---|---|---|
| API boundary | Implemented for the current **208** OpenAPI paths, **209** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **208** OpenAPI paths and **209** manifest route operations |
