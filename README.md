...
|---|---|---|
| API boundary | Implemented for the current **238** OpenAPI paths, **239** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **238** OpenAPI paths and **239** manifest route operations |
