# Ultimate AI Agent Canonical Bundle v0.7.0

This is the active project baseline after implementing Milestone M3 (Consent Ledger and Tool Broker Policy Engine).
