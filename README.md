...
|---|---|---|
| API boundary | Implemented for the current **249** OpenAPI paths, **250** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **249** OpenAPI paths and **250** manifest route operations |
