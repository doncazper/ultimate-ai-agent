...
|---|---|---|
| API boundary | Implemented for the current **202** OpenAPI paths, **203** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **202** OpenAPI paths and **203** manifest route operations |
