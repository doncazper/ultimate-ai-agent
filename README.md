...
|---|---|---|
| API boundary | Implemented for the current **214** OpenAPI paths, **215** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **214** OpenAPI paths and **215** manifest route operations |
