...
|---|---|---|
| API boundary | Implemented for the current **207** OpenAPI paths, **208** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **207** OpenAPI paths and **208** manifest route operations |
