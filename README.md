...
|---|---|---|
| API boundary | Implemented for the current **248** OpenAPI paths, **249** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **248** OpenAPI paths and **249** manifest route operations |
