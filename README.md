...
|---|---|---|
| API boundary | Implemented for the current 149-path FastAPI/OpenAPI boundary and `/api/manifest` metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **149** OpenAPI paths |
