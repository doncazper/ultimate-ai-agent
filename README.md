...
|---|---|---|
| API boundary | Implemented for the current **241** OpenAPI paths, **242** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **241** OpenAPI paths and **242** manifest route operations |
