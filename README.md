...
|---|---|---|
| API boundary | Implemented for the current **221** OpenAPI paths, **222** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **221** OpenAPI paths and **222** manifest route operations |
