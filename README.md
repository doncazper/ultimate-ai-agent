...
|---|---|---|
| API boundary | Implemented for the current **222** OpenAPI paths, **223** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **222** OpenAPI paths and **223** manifest route operations |
