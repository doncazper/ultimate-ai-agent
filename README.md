...
|---|---|---|
| API boundary | Implemented for the current **206** OpenAPI paths, **207** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **206** OpenAPI paths and **207** manifest route operations |
