...
|---|---|---|
| API boundary | Implemented for the current **195** OpenAPI paths, **196** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **195** OpenAPI paths and **196** manifest route operations |
