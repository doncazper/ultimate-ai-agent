...
|---|---|---|
| API boundary | Implemented for the current **224** OpenAPI paths, **225** `/api/manifest` route operations, and route metadata. | [docs/api/README.md](docs/api/README.md) |
...
| API boundary | FastAPI route contract with **224** OpenAPI paths and **225** manifest route operations |
