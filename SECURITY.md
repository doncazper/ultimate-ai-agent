...
Status: active public security posture for v0.100.0
...
|---|---|---|
| `main` / v0.100.0 / package `0.100.0` | Supported for security review and fixes | Current active baseline plus accepted checkpoint-m166 and checkpoint-m167 context. |
