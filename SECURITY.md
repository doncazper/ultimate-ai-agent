...
Status: active public security posture for v2.0.0
...
|---|---|---|
| `main` / v2.0.0 / package `2.0.0` | Supported for security review and fixes | Current active baseline plus accepted checkpoint-m166 and checkpoint-m167 context. |
