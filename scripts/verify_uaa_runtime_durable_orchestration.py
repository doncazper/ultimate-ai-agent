...
def main() -> int:
    ...
    docs = [
        ROOT / "docs/control_center/UAA_RUNTIME_DURABLE_ORCHESTRATION.md",
    ...
    for doc in docs:
        ...
        if doc.name == "UAA_RUNTIME_DURABLE_ORCHESTRATION.md":
            for fragment in [
    ...
    if failures:
        ...
        return 1
    print("UAA runtime durable orchestration verifier passed")
    return 0
