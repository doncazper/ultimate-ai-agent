...
ROUTE_OPERATION_IDS = {
    ...
    "/control-center/communications/conversations": "get_control_center_communications_conversations",
    "/control-center/communications/conversations/{conversation_ref}": "get_control_center_communications_conversation",
