...
def verify() -> list[str]:
    ...
    required_by_file = {
        ...
        "sessions": (
            ...
            "_origin_session_operation_ambiguity_evidence_valid",
        ...
        "tests": (
            ...
            "test_revoke_state_conflict_before_keychain_delete_is_failed_and_not_retried",
            "test_operation_proof_failure_leaves_no_origin_session_mutation",
            "test_proof_failure_hides_transition_from_cross_store_adopter",
            "test_revoke_commit_failure_after_delete_has_exact_ambiguity_proof",
            "test_session_commit_failure_after_preproof_is_non_retryable_ambiguity",
        ...
        "doc": (
            ...
            "per-origin session",
            "no browser session",
            "content-free operation proof",
            "exact durable terminal kernel row",
            "Legacy terminal lane",
            "every terminal row missing its binding",
            "structural provenance, not a signature",
            "not a signature",
            "standing authority",
            "Queue 02",
        ),
