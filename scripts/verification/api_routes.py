...
EXPECTED_ROUTE_COUNT = 197
EXPECTED_OPENAPI_PATH_COUNT = 196
EXPECTED_AUTH_POSTURE_SUMMARY = {
    "public_metadata_no_auth": 3,
    "protected_local_bearer_required": 194,
}
...
EXPECTED_CONTROL_CENTER_ROUTE_COUNT = 86
