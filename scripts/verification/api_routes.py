...
EXPECTED_ROUTE_COUNT = 246
EXPECTED_OPENAPI_PATH_COUNT = 245
EXPECTED_AUTH_POSTURE_SUMMARY = {
    "public_metadata_no_auth": 3,
    "protected_local_bearer_required": 243,
}
EXPECTED_APPROVAL_POSTURE_SUMMARY = {
    "not_required_for_route_classification": 198,
...
EXPECTED_CONTROL_CENTER_ROUTE_COUNT = 90
