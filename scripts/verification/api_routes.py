...
EXPECTED_ROUTE_COUNT = 164
EXPECTED_AUTH_POSTURE_SUMMARY = {
    "public_metadata_no_auth": 3,
    "protected_local_bearer_required": 161,
}
EXPECTED_APPROVAL_POSTURE_SUMMARY = {
    "not_required_for_route_classification": 130,
...
EXPECTED_RATE_LIMIT_POSTURE_SUMMARY = {
    "not_targeted_for_route": 108,
    "targeted_local_fixed_window": 56,
}
...
EXPECTED_CONTROL_CENTER_ROUTE_COUNT = 63
