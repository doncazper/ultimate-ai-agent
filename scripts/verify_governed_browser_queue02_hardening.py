...
def verify() -> list[str]:
    ...
    required = {
        ...
        "operation_proof_tests": (
            ...
            "test_terminal_binding_write_failure_rolls_back_receipt_commit",
        ...
        "replay_provenance_tests": (
            ...
            "test_exact_terminal_binding_rejects_same_shape_proof_substitution",
            "test_recomputed_envelope_hash_cannot_rebind_any_provenance_field",
            "test_completed_dispatch_replay_requires_complete_provenance",
            "test_release_path_rejects_settlement_detail_substitution",
            "test_settlement_path_rejects_release_detail_substitution",
            "test_settlement_path_rejects_interleaved_lifecycle_and_accounting",
            "test_deny_by_default_budget_receipt_has_canonical_blocked_provenance",
            "test_late_operation_ambiguity_timeout_accepts_exact_evidence",
        ),
        "browser_actions": (
        ...
        "tests": (
            ...
            "test_dispatch_worker_owns_reentrant_approval_lock_without_deadlock",
            "test_dispatch_result_validation_cancellation_publishes_terminal_attempt",
            "test_post_dispatch_revalidation_cancellation_preserves_exact_attempt",
            "test_ambiguous_dispatch_keeps_primary_before_post_dispatch_denial",
            "test_post_return_cancellation_uses_the_assigned_dispatch_attempt",
            "test_budget_settlement_cancellation_is_terminal_and_preserves_evidence",
            "test_deferred_timeout_revalidation_cancellation_preserves_exact_attempt",
            "test_timeout_wait_cancellation_transfers_ownership_until_callback_stops",
            "test_post_wait_cancellation_synchronously_binds_completed_attempt",
            ...
            "test_same_process_store_cannot_reap_a_live_dispatch_slot",
            "test_migrated_legacy_dispatch_slot_is_reaped_before_a_new_claim",
            "test_restart_recovery_reaps_a_migrated_legacy_dispatch_slot",
            "test_unknown_dispatch_lock_protocol_remains_fail_closed",
            "test_dispatch_owner_rechecks_protocol_after_acquiring_flock",
        ...
        "artifact_transfer_review_tests": (
            "test_oversized_download_payload_uses_bounded_owned_sentinel_before_dispatch",
            "test_oversized_download_uses_only_a_bounded_worker_sentinel",
            "test_service_proof_failure_precedes_quarantine_and_retry_is_clean",
            "test_quarantine_failure_reuses_exact_durable_proof_on_clean_retry",
        ...
        "doc": (
            ...
            "durably persisted immediately before the SQLite",
            "inert, idempotent sidecar",
