...
DOC_REQUIRED = [
    "UAA Runtime Parity Final Hardening",
...
def main() -> int:
    ...
    doc = _read("docs/runtime/UAA_RUNTIME_PARITY_FINAL_HARDENING.md")
    scorecard = _read("docs/runtime/UAA_RUNTIME_PARITY_SCORECARD.md")
    ...
    print("UAA runtime parity final hardening verified")
    return 0
