...
def verify() -> list[str]:
    ...
    required_by_file = {
        "composer": (
            ...
            "snapshot.transaction_ref != self.transaction_ref",
            "snapshot.intent_ref != self.intent_ref",
            "GOVERNED_TASK_COMPOSER_RECEIPT_REASON_REQUIRED",
            "GOVERNED_TASK_COMPOSER_SUCCESS_REASON_INVALID",
            "GOVERNED_TASK_COMPOSER_PLAN_RECIPE_MISMATCH",
            "GOVERNED_TASK_COMPOSER_OPERATION_AUTHORITY_DUPLICATE",
            "recipe_snapshot",
