...
REQUIRED_FILES = [
    ...
    "src/components/ProofDetailPanel.tsx",
    "src/components/SourceInboxSurfacePanel.tsx",
    "src/components/StartHerePanel.tsx",
    "src/components/TrustAuthorityPanel.tsx",
...
FORBIDDEN_ENDPOINTS = [
    ...
    "/control-center/git/merge",
    "/control-center/git/rebase",
    "/control-center/git/pr",
...
EXPECTED_SCOPED_FRONTEND_POST_HELPERS = 27
