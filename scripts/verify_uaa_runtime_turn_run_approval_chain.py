#!/usr/bin/env python3
"""Verify the UAA runtime turn/run/approval chain slice."""
...
DOC_PATH = ROOT / "docs" / "runtime" / "UAA_RUNTIME_TURN_RUN_APPROVAL_CHAIN.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if failures:
        ...
        return 1
    print("UAA runtime turn/run/approval chain verified")
    return 0
